---
title: 'Configuration'
description: 'config.json reference for self-hosted Noctis.'
---
...
| federation? | [federation](#federation) | Federation configuration for connecting with other Noctis instances. Default: `{}` |
...
| services | [services](#services) | Configuration for individual Noctis services. |
...
| Property | Type | Description |
|----------|------|-------------|
| bluesky? | [bluesky](#bluesky) | Bluesky OAuth client configuration. Default: `{"enabled":true,"client_name":"Noctis","client_uri":"","logo_uri":"https://static.noctis.app/web/apple-touch-icon.png","tos_uri":"https://noctis.app/terms","policy_uri":"https://noctis.app/privacy","keys":[]}` |
...
| Property | Type | Description |
|----------|------|-------------|
| additional_allowed_origins? | array&lt;string&gt; | List of allowed origins for WebAuthn registration/authentication. Default: `["https://web.noctis.app","https://web.canary.noctis.app"]` |
| rp_id? | string | Relying Party ID (domain) for WebAuthn credentials. Default: `noctis.app` |
| rp_name? | string | Relying Party name displayed to users. Default: `Noctis` |

<Expandable title="Example JSON">
```json
{
  "additional_allowed_origins": [
    "https://web.noctis.app",
    "https://web.canary.noctis.app"
  ],
  "rp_id": "noctis.app",
  "rp_name": "Noctis"
}
...
| Property | Type | Description |
|----------|------|-------------|
| client_name? | string | Human-readable client name exposed to Bluesky. Default: `Noctis` |
...
| logo_uri? | string | Optional logo presented during authorization. Default: `https://static.noctis.app/web/apple-touch-icon.png` |
| policy_uri? | string | Privacy policy URI exposed to Bluesky. Default: `https://noctis.app/privacy` |
| tos_uri? | string | Terms of service URI exposed to Bluesky. Default: `https://noctis.app/terms` |
...
```json
{
  ...
  "enabled": true,
  "keys": [],
  "logo_uri": "https://static.noctis.app/web/apple-touch-icon.png",
  "policy_uri": "https://noctis.app/privacy",
  "tos_uri": "https://noctis.app/terms"
}
```
</Expandable>
...
| sqlite_path? | string | Filesystem path to the SQLite database file. Default: `./data/noctis.db` |

<Expandable title="Example JSON">
```json
{
  "backend": "cassandra",
  "sqlite_path": "./data/noctis.db"
}
```
</Expandable>
...
| static_cdn_domain? | string | Separate domain for static CDN assets (optional). Default: `static.noctis.app` |
...
```json
{
  ...
  "public_port": 8088,
  "public_scheme": "http",
  "static_cdn_domain": "static.noctis.app"
}
```
</Expandable>
...
Federation configuration for connecting with other Noctis instances.

| Property | Type | Description |
|----------|------|-------------|
| enabled? | boolean | Enable federation with other Noctis instances. Default: `false` |
...
Specific settings for this Noctis instance.

| Property | Type | Description |
|----------|------|-------------|
| auto_join_invite_code? | string | Invite code to auto-join users to a guild upon registration. Default: `""` |
| deployment_mode? | enum&lt;`monolith`, `microservices`&gt; | Deployment mode. 'monolith' runs all services in one process (noctis_server). 'microservices' requires separate processes/ports. Default: `monolith` |
...
| from_name? | string | Default sender name. Default: `Noctis` |
...
| Property | Type | Description |
|----------|------|-------------|
| cdn? | string | Bucket for CDN assets. Default: `noctis` |
| downloads? | string | Bucket for downloads. Default: `noctis-downloads` |
| harvests? | string | Bucket for data harvests. Default: `noctis-harvests` |
| reports? | string | Bucket for report data. Default: `noctis-reports` |
| static? | string | Bucket for static site assets. Default: `noctis-static` |
| uploads? | string | Bucket for user uploads. Default: `noctis-uploads` |

<Expandable title="Example JSON">
```json
{
  "cdn": "noctis",
  "downloads": "noctis-downloads",
  "harvests": "noctis-harvests",
  "reports": "noctis-reports",
  "static": "noctis-static",
  "uploads": "noctis-uploads"
}
```
</Expandable>
...
| enabled? | boolean | Whether to enable the Marketing service within noctis_server. Default: `false` |
| host? | string | Network interface to bind to. Default: `0.0.0.0` |
...
| release_node? | string | Erlang node name for the release. Default: `noctis_gateway@gateway` |
...
```json
{
  ...
  "release_node": "noctis_gateway@gateway"
}
```
</Expandable>
...
Configuration for the main Noctis Server.
...
| service_name? | string | Service name reported to telemetry. Default: `noctis` |
