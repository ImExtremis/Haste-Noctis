 ...
 * The scope values must match OAuthScopes from @noctis/schema/src/domains/oauth/OAuthSchemas.tsx
 */
...
async function main() {
	...
	const outPath = path.join(repoRoot, 'noctis_docs/topics/oauth2.mdx');

	let out = '';
	out += createFrontmatter({
		title: 'OAuth2',
		description: 'OAuth2 scopes in Noctis and what each scope enables.',
	});
	out += '\n\n';
