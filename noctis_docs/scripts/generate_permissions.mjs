...
/**
 * Permission definitions from @noctis/constants.
...
async function main() {
	...
	const outPath = path.join(repoRoot, 'noctis_docs/topics/permissions.mdx');

	let out = '';
	out += createFrontmatter({
		title: 'Permissions',
		description: 'Reference for permission bitfields used by Noctis guilds and channels.',
	});
	out += '\n\n';

	out += 'Permissions in Noctis are stored as a bitfield, represented as a string containing the permission integer. ';
