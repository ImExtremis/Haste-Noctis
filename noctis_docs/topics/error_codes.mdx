...
| `CANNOT_REDEEM_STELLAR_WITH_VISIONARY` | Cannot redeem stellar while having Visionary subscription |
...
| `NO_USERS_WITH_NOCTISTAG_EXIST` | No users with this Noctistag exist |
...
| `VANITY_URL_CODE_CANNOT_CONTAIN_NOCTIS` | Vanity URL code cannot contain noctis |
