...
The media proxy serves all user-generated content for Noctis, including avatars, icons, attachments, emojis, stickers, and external media. All public routes are served from `https://noctisusercontent.com`.
