 ...
 * Copyright (C) {year} Noctis Contributors
 *
 * This file is part of Noctis.
 *
 * Noctis is free software: you can redistribute it and/or modify
...
const ERLANG_LICENSE_HEADER = `%% Copyright (C) {year} Noctis Contributors
%%
%% This file is part of Noctis.
%%
%% Noctis is free software: you can redistribute it and/or modify
...
const SHELL_LICENSE_HEADER = `# Copyright (C) {year} Noctis Contributors
#
# This file is part of Noctis.
#
# Noctis is free software: you can redistribute it and/or modify
...
class Processor {
	...
	private shouldIgnore(filePath: string): boolean {
		if (filePath.includes('noctis_static')) {
			return true;
		}
	...
	private detectLicense(content: string): {hasHeader: boolean; detectedYear: number | null} {
		...
		for (const line of lines) {
			...
			if (lower.includes('noctis')) {
				hasNoctis = true;
			}
			if (lower.includes('copyright') && lower.includes('noctis') && detectedYear === null) {
		...
		return {hasHeader: hasAgpl && hasNoctis, detectedYear};
	}
