...
const MIGRATION_KEYSPACE = process.env['CASSANDRA_KEYSPACE'] ?? 'noctis';
const MIGRATIONS_DIR = '../noctis_devops/cassandra/migrations';
...
function printUsage(): void {
	console.log(`cassandra-migrate - Forward-only Cassandra migration tool for Noctis

A simple, forward-only migration tool for Cassandra.
Migrations are stored in noctis_devops/cassandra/migrations.
Migration metadata is stored in the 'noctis' keyspace.
