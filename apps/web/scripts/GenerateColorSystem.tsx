...
hsl(220, calc(13% * var(--saturation-factor)), 2%) 20%
			...
			{name: '--stellar', value: 'var(--brand-primary)'},
			{name: '--stellar-hover', value: 'var(--brand-secondary)'},
			{name: '--stellar-text', value: 'var(--text-on-brand-primary)'},
			{name: '--stellar-icon', family: 'brandIcon', lightness: 50},
...
hsl(245, calc(100% * var(--saturation-factor)), 80%) 40%
		...
		light: [
			...
			{name: '--stellar-hover', value: 'var(--brand-secondary)'},
			{name: '--stellar-text', value: 'var(--text-on-brand-primary)'},
			{name: '--stellar-icon', family: 'brandIcon', lightness: 45},
