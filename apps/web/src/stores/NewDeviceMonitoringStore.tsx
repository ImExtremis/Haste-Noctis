			...
			modal(() => (
				<ConfirmModal
					...
					description={
						deviceType === 'input' ? (
							<Trans>
								Noctis has found a new audio input device named <strong>{deviceName}</strong>. Do you want to switch to
								it?
							</Trans>
						) : (
							<Trans>
								Noctis has found a new audio output device named <strong>{deviceName}</strong>. Do you want to switch to
								it?
							</Trans>
						)
					}
