...
import type {ChannelId, GuildId} from '@noctis/schema/src/branded/WireIds';
import type {Message} from '@noctis/schema/src/domains/message/MessageResponseSchemas';
import {compare as compareSnowflakes, extractTimestamp, fromTimestamp} from '@noctis/snowflake/src/SnowflakeUtils';
