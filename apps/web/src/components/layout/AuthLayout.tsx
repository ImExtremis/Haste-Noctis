...
import NoctisWordmarkMonochrome from '@app/images/noctis-logo-wordmark-monochrome.svg?react';
...
import {GuildSplashCardAlignment} from '@noctis/constants/src/GuildConstants';
						...
						>
							<div className={styles.mobileContent}>
								<div className={styles.mobileLogoContainer}>
									<NoctisWordmarkMonochrome className={styles.mobileWordmark} />
								</div>
								{children}
							</div>
						</Scroller>
