...
import styles from '@app/components/layout/app_layout/nagbars/DesktopDownloadNagbar.module.css';
...
export const DesktopDownloadNagbar = observer(({isMobile}: {isMobile: boolean}) => {
	const handleDownload = () => {
		openExternalUrl('https://noctis.app/download');
	};
	...
	return (
		...
		>
			<NagbarContent
				isMobile={isMobile}
				onDismiss={handleDismiss}
				message={<Trans>Get the Noctis desktop app for system-wide push-to-talk and a few other goodies.</Trans>}
				actions={
					<>
