...
export const MobileDownloadNagbar = observer(({isMobile}: {isMobile: boolean}) => {
	const handleDownload = () => {
		openExternalUrl('https://noctis.app/download#mobile');
	};
	...
	return (
		...
		>
			<NagbarContent
				isMobile={isMobile}
				onDismiss={handleDismiss}
				message={<Trans>Install Noctis on your phone as a home screen app to receive notifications on the go!</Trans>}
				actions={
					<>
