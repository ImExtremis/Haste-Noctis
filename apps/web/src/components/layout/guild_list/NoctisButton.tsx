...
import {NoctisSymbol} from '@app/components/icons/NoctisSymbol';
...
export const NoctisButton = observer(() => {
	const {t} = useLingui();
			...
			<FocusRing offset={-2} focusTarget={buttonRef} ringTarget={iconRef}>
				...
				>
					...
					<div className={styles.relative}>
						<motion.div
							ref={iconRef}
							className={clsx(styles.noctisButtonIcon, isSelected && styles.noctisButtonIconSelected)}
							animate={{borderRadius: isActive ? '30%' : '50%'}}
							initial={false}
							transition={{duration: 0.07, ease: 'easeOut'}}
							whileHover={{borderRadius: '30%'}}
						>
							<NoctisSymbol className={styles.noctisSymbolIcon} />
						</motion.div>
