...
import type {OAuth2Scope} from '@noctis/constants/src/OAuth2Constants';
...
const OAuthAuthorizePage: React.FC = observer(() => {
	...
	useNoctisDocumentTitle(t`Authorize Application`);
		...
		return (
			<div className={styles.page}>
				<div className={styles.pageLogo}>
					<NoctisWordmarkMonochrome className={styles.pageWordmark} />
				</div>
