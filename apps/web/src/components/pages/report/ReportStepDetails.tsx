		...
		<div className={styles.card}>
			...
			<div className={styles.cardBody}>
				...
				>
					...
					{selectedType === 'message' && (
						<>
							<Input
								...
								placeholder="https://noctis.app/channels/..."
								autoComplete="off"
					...
					<Input
						label={t`Your NoctisTag (Optional)`}
						type="text"
						value={formValues.reporterNoctisTag}
						onChange={(e) => onFieldChange('reporterNoctisTag', e.target.value)}
						placeholder="username#1234"
						error={fieldErrors.reporterNoctisTag}
					/>
