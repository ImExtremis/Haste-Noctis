...
export const NetworkErrorScreen = () => {
	...
	return (
		<div className={styles.errorFallbackContainer}>
			<NoctisIcon className={styles.errorFallbackIcon} />
			<div className={styles.errorFallbackContent}>
				...
				<p className={styles.errorFallbackDescription}>
					<Trans>
						We're having trouble connecting to Noctis's servers. This could be a temporary network issue or scheduled
						maintenance.
					</Trans>
				</p>
				<p className={styles.errorFallbackDescription}>
					<Trans>
						Check our{' '}
						<a href="https://bsky.app/profile/noctis.app" target="_blank" rel="noopener noreferrer">
							Bluesky (@noctis.app)
						</a>{' '}
						for status updates.
					</Trans>
