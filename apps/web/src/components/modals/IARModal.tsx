...
import {MessagePreviewContext} from '@noctis/constants/src/ChannelConstants';
			...
			<Modal.Content>
				<Modal.ContentLayout>
					<p className={styles.description}>
						<Trans>
							Thank you for helping keep Noctis safe. Reports are reviewed by our Safety Team. False reports may result
