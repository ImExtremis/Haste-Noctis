...
import type {RequiredAction} from '@noctis/schema/src/domains/user/UserResponseSchemas';
...
const getDescriptionDescriptor = (
	...
	switch (mode) {
		case 'email':
			if (emailBounced) {
				return msg`Your current email address couldn't receive messages. Please update it to continue using Noctis.`;
			}
			return reverify
				? msg`We've detected suspicious activity on your account. Please reverify your email address to continue using Noctis.`
				: msg`We've detected suspicious activity on your account. Please verify your email address to continue using Noctis.`;
		case 'phone':
			return reverify
				? msg`We've detected suspicious activity on your account. Please reverify your phone number to continue using Noctis.`
				: msg`We've detected suspicious activity on your account. Please verify your phone number to continue using Noctis.`;
		case 'email_or_phone':
			return reverify
				? msg`We've detected suspicious activity on your account. Please reverify your email address or phone number to continue using Noctis.`
				: msg`We've detected suspicious activity on your account. Please verify your email address or phone number to continue using Noctis.`;
	}
};
