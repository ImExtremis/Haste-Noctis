...
import styles from '@app/components/modals/components/stellar/GiftSection.module.css';
import {PurchaseDisabledWrapper} from '@app/components/modals/components/stellar/PurchaseDisabledWrapper';
...
export const GiftSection: React.FC<GiftSectionProps> = observer(
	({
		...
		const {t} = useLingui();
		const tooltipText: React.ReactNode = purchaseDisabledTooltip ?? t`Claim your account to purchase Noctis Stellar.`;

		return (
			<div ref={giftSectionRef}>
				<section className={styles.section}>
					<SectionHeader
						title={<Trans>Gift Stellar</Trans>}
						description={
							<Trans>Share the Stellar experience with your friends by purchasing a gift subscription.</Trans>
						}
					/>
					...
					<div className={styles.footerContainer}>
						...
						<div className={styles.scrollPromptContainer}>
							<p className={styles.scrollPromptText}>
								<Trans>Scroll down to view all the sweet perks you get with Stellar</Trans>
							</p>
