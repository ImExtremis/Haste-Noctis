...
import type {GracePeriodInfo} from '@app/components/modals/components/stellar/hooks/useSubscriptionStatus';
import styles from '@app/components/modals/components/stellar/SubscriptionCard.module.css';
	...
	({
		...
		const tooltipText: string | (() => React.ReactNode) =
			purchaseDisabledTooltip != null
				? () => purchaseDisabledTooltip
				: t`Claim your account to purchase or redeem Noctis Stellar.`;
					...
					<div className={styles.content}>
						<div className={styles.header}>
							<h3 className={styles.title}>
								{isVisionary ? <Trans>Visionary</Trans> : <Trans>Stellar Subscription</Trans>}
							</h3>
