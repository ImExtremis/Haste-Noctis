...
import styles from '@app/components/modals/components/StellarContent.module.css';
import {PurchaseDisclaimer} from '@app/components/modals/components/PurchaseDisclaimer';
import {BottomCTASection} from '@app/components/modals/components/stellar/BottomCTASection';
import {GiftInventoryBanner} from '@app/components/modals/components/stellar/GiftInventoryBanner';
import {GiftSection} from '@app/components/modals/components/stellar/GiftSection';
import {useCheckoutActions} from '@app/components/modals/components/stellar/hooks/useCheckoutActions';
import {useCommunityActions} from '@app/components/modals/components/stellar/hooks/useCommunityActions';
import {usePremiumData} from '@app/components/modals/components/stellar/hooks/usePremiumData';
import {useSubscriptionActions} from '@app/components/modals/components/stellar/hooks/useSubscriptionActions';
import {useSubscriptionStatus} from '@app/components/modals/components/stellar/hooks/useSubscriptionStatus';
import {StellarUpsellBanner} from '@app/components/modals/components/stellar/StellarUpsellBanner';
import {PricingSection} from '@app/components/modals/components/stellar/PricingSection';
import {PurchaseHistorySection} from '@app/components/modals/components/stellar/PurchaseHistorySection';
import {SectionHeader} from '@app/components/modals/components/stellar/SectionHeader';
import {SubscriptionCard} from '@app/components/modals/components/stellar/SubscriptionCard';
...
interface StellarContentProps {
	defaultGiftMode?: boolean;
}

export const StellarContent = observer(({defaultGiftMode = false}: StellarContentProps) => {
	...
	const purchaseDisabledTooltip = <Trans>Claim your account to purchase Noctis Stellar.</Trans>;
			...
			<div className={styles.giftModeContainer}>
				...
				<div ref={perksSectionRef}>
					<section className={styles.perksSection}>
						<SectionHeader title={<Trans>Free vs Stellar</Trans>} />
