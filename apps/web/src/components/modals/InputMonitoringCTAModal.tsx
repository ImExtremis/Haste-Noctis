		...
		try {
			...
			if (result === 'granted') {
				...
				ToastActionCreators.createToast({
					type: 'info',
					children: t`Please enable Noctis in System Settings → Privacy & Security → Input Monitoring.`,
				});
			}
		...
		<Modal.Root size="small" centered initialFocusRef={initialFocusRef}>
			...
			<Modal.Content>
				<Modal.ContentLayout>
					<Modal.Description>
						<Trans>
							Noctis needs permission to monitor keyboard and mouse input so that <strong>Push-to-Talk</strong> and{' '}
