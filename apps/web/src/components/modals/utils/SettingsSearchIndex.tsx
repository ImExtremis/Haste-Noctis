...
const ADDITIONAL_SEARCHABLE_ITEMS: Array<SearchableSettingDescriptor> = [
	...
	},
	{
		...
		tabType: 'my_profile',
		label: msg`Badge`,
		keywords: [msg`badge`, msg`premium badge`, msg`nitro`, msg`stellar`],
	...
	{
		id: 'stellar-subscription',
		tabType: 'stellar',
		label: msg`Subscription`,
		keywords: [msg`stellar`, msg`premium`, msg`subscription`, msg`nitro`, msg`upgrade`, msg`plan`],
