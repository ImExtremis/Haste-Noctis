	...
	if (!hasGlobalExpressions) {
		return (
			<div className={styles.emptyState}>
				<StatusSlate
					Icon={StickerIcon}
					title={<Trans>Expression Packs are a Stellar feature</Trans>}
					description={<Trans>Create and share custom emoji and sticker packs with Noctis Stellar.</Trans>}
					actions={[
						{
							text: <Trans>Learn about Stellar</Trans>,
