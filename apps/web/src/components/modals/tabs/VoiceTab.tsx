				...
				modal(() => (
					<ConfirmModal
						...
						description={
							<p>
								<Trans>
									In your browser, Push-to-Talk will only work when the Noctis tab is focused. For system-wide
						...
						onPrimary={() => {
							void openExternalUrl('https://noctis.app/download');
						}}
						onSecondary={() => {
					...
					<div className={styles.deviceNoticeText}>
						...
						<p className={styles.deviceNoticeDescription}>
							{permissionStatus === 'denied' ? (
								isNativeDesktop ? (
									<Trans>
										Allow Noctis to access your microphone in System Settings → Privacy &amp; Security → Microphone.
									</Trans>
								) : (
									<Trans>
										Allow Noctis to access your microphone. Check your browser address bar or settings to enable
										permissions.
									</Trans>
								)
							) : (
								<Trans>Noctis needs access to list the available microphones and speakers.</Trans>
							)}
						</p>
					</div>
					<Button
							...
							link={
								!isNativeDesktop
									? {
											...
											onClick: () => void openExternalUrl('https://noctis.app/download'),
										}
									: {
