		...
		return (
			<>
						...
						<div className={styles.deviceNoticeText}>
							...
							<p className={styles.deviceNoticeDescription}>
								{permissionStatus === 'denied' ? (
									<Trans>
										Allow Noctis to access your camera in System Settings → Privacy &amp; Security → Camera to preview
										and select devices.
									</Trans>
								) : (
									<Trans>Noctis needs access to your camera before we can list it here.</Trans>
								)}
							</p>
						</div>
						<Button
				...
				<Switch
					...
					description={<Trans>Freezes your preview while Noctis is in the background to save resources.</Trans>}
					...
					<div className={styles.premiumCard}>
						<div className={styles.premiumHeader}>
							...
							<span className={styles.premiumTitle}>
								<Trans>Unlock HD Screen Sharing with Stellar</Trans>
							</span>
						</div>
				...
				<div>
					...
					{!hasHigherQuality && !RuntimeConfigStore.isSelfHosted() && (
						<div className={styles.frameRateNote}>
							...
							<Trans>Frame rates above 30 FPS require Stellar</Trans>
						</div>
					)}
				</div>
			</>
