...
import type {LimitCategory, LimitKeyMetadata} from '@noctis/constants/src/LimitConfigMetadata';
import {LIMIT_CATEGORY_LABELS, LIMIT_KEY_METADATA} from '@noctis/constants/src/LimitConfigMetadata';
