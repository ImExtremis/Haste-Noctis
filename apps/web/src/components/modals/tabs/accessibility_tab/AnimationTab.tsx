...
import {StickerAnimationOptions} from '@noctis/constants/src/UserConstants';
...
export const AnimationTabContent: React.FC = observer(() => {
	...
	return (
		<>
			...
			<Switch
				label={mobileLayout.enabled ? t`Automatically play GIFs` : t`Automatically play GIFs when Noctis is focused`}
				description={
