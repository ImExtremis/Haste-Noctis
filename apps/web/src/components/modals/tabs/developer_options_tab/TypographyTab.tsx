		...
		<div className={styles.container}>
			<div className={styles.section}>
				...
				<p className={styles.description}>
					<Trans>
						Preview all available fonts, weights, and styles across different languages supported by Noctis.
					</Trans>
				</p>
			</div>
				...
				<div className={styles.multilingualCard}>
					<div className={styles.multilingualList} style={{fontFamily: 'var(--font-sans)', lineHeight: 1.6}}>
						<div className={styles.multilingualItem}>
							<strong>English:</strong> Welcome to Noctis's typography showcase
						</div>
						...
						<div className={styles.multilingualItem} lang="ko">
							<strong>한국어:</strong> Noctis의 타이포그래피 쇼케이스에 오신 것을 환영합니다
						</div>
						<div className={styles.multilingualItem} lang="zh-CN">
							<strong>简体中文:</strong> 欢迎来到 Noctis 的字体展示
						</div>
						<div className={styles.multilingualItem} lang="zh-TW">
							<strong>繁體中文:</strong> 歡迎來到 Noctis 的字體展示
						</div>
						<div className={styles.multilingualItem} lang="ar" dir="rtl">
							<strong>العربية:</strong> مرحباً بك في عرض طباعة Noctis
						</div>
						<div className={styles.multilingualItem} lang="he">
							<strong>עברית:</strong> ברוכים הבאים לתצוגת הטיפוגרפיה של Noctis
						</div>
						<div className={styles.multilingualItem} lang="hi">
							<strong>हिंदी:</strong> Noctis के टाइपोग्राफी शोकेस में आपका स्वागत है
						</div>
						<div className={styles.multilingualItem} lang="th">
							<strong>ไทย:</strong> ยินดีต้อนรับสู่การจัดแสดงพิมพ์ของ Noctis
						</div>
					</div>
				</div>
			</div>
