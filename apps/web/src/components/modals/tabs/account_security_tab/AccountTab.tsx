...
import {EmailVerificationAlert} from '@app/components/modals/components/EmailVerificationAlert';
		...
		return (
			<>
				...
				<SettingsTabSection
					...
					description={<Trans>Manage the email address you use to sign in to Noctis</Trans>}
				>
					{isClaimed ? (
						<>
