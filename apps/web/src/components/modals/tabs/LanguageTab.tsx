...
import {TimeFormatTypes} from '@noctis/constants/src/UserConstants';
			...
			<div className={styles.notice}>
				<p className={styles.noticeText}>
					<Trans>
						...
						help us localize Noctis into your language! To do so, send an email to{' '}
						<a href="mailto:i18n@noctis.app" className={styles.link}>
							i18n@noctis.app
						</a>{' '}
