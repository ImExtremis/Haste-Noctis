...
import {StellarLink} from '@app/components/uikit/stellar_link/StellarLink';
				...
				{!isPerGuildProfile && (
					<div className={styles.description}>
						{hasAnimatedAvatar ? (
							...
							<Trans>
								JPEG, PNG, WebP. Max 10MB. Recommended: 512×512px. Animated avatars (GIF) require <StellarLink />.
							</Trans>
						) : (
