			...
			<div>
				<div className={styles.header}>
					<h2 className={styles.title}>
						<Trans>Stellar Badge Privacy</Trans>
					</h2>
					<p className={styles.description}>
						<Trans>Control how your Stellar badge is displayed to others</Trans>
					</p>
				</div>

				<div className={styles.switches}>
					<Switch
						label={t(i18n)`Hide Stellar badge entirely`}
						description={t(i18n)`Completely hide your Stellar badge from other users`}
					...
					<Switch
						label={
							premiumSince
								? t(i18n)`Hide Stellar purchase date (${DateUtils.getFormattedShortDate(premiumSince)})`
								: t(i18n)`Hide Stellar purchase date`
						}
						description={t(i18n)`Remove when you first bought Stellar from your badge`}
