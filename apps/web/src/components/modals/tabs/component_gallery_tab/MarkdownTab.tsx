...
import {MessagePreviewContext, MessageStates, MessageTypes} from '@noctis/constants/src/ChannelConstants';
	...
	const {fakeChannel, createMessage, markdownSections} = useMemo(() => {
		...
		const markdownSections = [
			...
			},
			{
				title: t`Links`,
				items: [
					{label: '[text](url)', content: '[Masked Link](https://noctis.app)'},
					{label: '<url>', content: '<https://noctis.app>'},
					{label: 'url', content: 'https://noctis.app'},
					{label: '<email>', content: '<contact@noctis.app>'},
				],
			},
			{
				title: t`Lists`,
