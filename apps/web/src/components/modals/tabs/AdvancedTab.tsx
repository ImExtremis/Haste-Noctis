		...
		<SettingsTabContainer>
			{isDesktop() && (
				<SettingsTabSection
					...
					description={<Trans>Run Noctis automatically when your computer starts. Or don't. Your choice!</Trans>}
				>
					<Switch
						label={<Trans>Launch Noctis at Login</Trans>}
			...
			{isDesktop() && (
				<SettingsTabSection
					...
					description={
						<Trans>Choose what Noctis remembers about your window between restarts and reloads on this device.</Trans>
					}
				>
					<Switch
					...
					<Switch
						...
						description={<Trans>Reopen in maximized mode if that&rsquo;s how you last used Noctis.</Trans>}
			...
			<SettingsTabSection
				...
				description={<Trans>Choose how Noctis selects the video codec for screen sharing.</Trans>}
			>
				<Switch
				...
				<Switch
					...
					description={
						<Trans>
							...
							data structures like messages, channels, users, and communities. Also includes tools to debug the Noctis
