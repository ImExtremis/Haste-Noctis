					...
					<div className={styles.pushSection}>
						<div>
							...
							<p className={styles.pushDescription}>
								{t`Noctis uses push notifications when installed as a mobile PWA. Registering ensures the gateway can reach your device even when the browser is backgrounded.`}
							</p>
						</div>
