	...
	return (
		<div className={styles.container}>
			...
			<p className={styles.description}>
				{t`Noctis avoids sending push notifications to your mobile devices when you are at your computer. Use this setting to control how long you need to be inactive on desktop for before you receive push notifications, ranging from 1 minute to 10 minutes.`}
			</p>
			<Slider
