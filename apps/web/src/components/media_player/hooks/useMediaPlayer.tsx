...
import {DEFAULT_VOLUME} from '@app/components/media_player/utils/MediaConstants';
import {Logger} from '@app/lib/Logger';
import {useCallback, useEffect, useRef, useState} from 'react';

const VOLUME_STORAGE_KEY = 'noctis:media:volume';
const MUTE_STORAGE_KEY = 'noctis:media:muted';
const PLAYBACK_RATE_STORAGE_KEY = 'noctis:media:playbackRate';
