...
export const VOLUME_STORAGE_KEY = 'noctis:media_player:volume';

export const MUTE_STORAGE_KEY = 'noctis:media_player:muted';

export const PLAYBACK_RATE_STORAGE_KEY = 'noctis:media_player:playback-rate';
