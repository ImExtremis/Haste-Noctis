...
import {ATTACHMENT_MAX_SIZE_PREMIUM} from '@noctis/constants/src/LimitConstants';
...
export const FileSizeTooLargeModal = observer(({oversizedFileCount}: FileSizeTooLargeModalProps) => {
	...
	const handleGetStellarClick = useCallback(() => {
		window.setTimeout(() => {
	...
	return (
		<ConfirmModal
			...
			description={
				<Trans>
					{baseDescription} With Stellar, your per-file upload limit increases to{' '}
			...
			onPrimary={handleGetStellarClick}
