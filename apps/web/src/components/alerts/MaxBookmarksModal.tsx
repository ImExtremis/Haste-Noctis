...
import {MAX_BOOKMARKS_PREMIUM} from '@noctis/constants/src/LimitConstants';
...
export const MaxBookmarksModal = observer(({user}: MaxBookmarksModalProps) => {
	...
	return (
		<ConfirmModal
			title={t`Bookmark Limit Reached`}
			description={t`You've reached the maximum number of bookmarks for free users (${bookmarksText}). Upgrade to Stellar to increase your limit to ${premiumBookmarksText}, or remove some bookmarks to add new ones.`}
			primaryText={t`Upgrade to Stellar`}
