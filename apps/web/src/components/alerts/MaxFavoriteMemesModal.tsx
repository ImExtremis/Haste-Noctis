...
import {MAX_FAVORITE_MEMES_PREMIUM} from '@noctis/constants/src/LimitConstants';
...
export const MaxFavoriteMemesModal = observer(() => {
	...
	const freeDescription = t`You've reached the maximum limit of ${freeItemsText} for free users. Upgrade to Stellar to increase your limit to ${premiumItemsText}!`;
