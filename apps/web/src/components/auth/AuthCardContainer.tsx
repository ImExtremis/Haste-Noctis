...
import NoctisLogo from '@app/images/noctis-logo-color.svg?react';
import NoctisWordmark from '@app/images/noctis-wordmark.svg?react';
			...
			<div className={clsx(authLayoutStyles.card, !showLogoSide && authLayoutStyles.cardSingle)}>
				{showLogoSide && (
					<div className={authLayoutStyles.logoSide}>
						<NoctisLogo className={authLayoutStyles.logo} />
						<NoctisWordmark className={authLayoutStyles.wordmark} />
					</div>
				)}
