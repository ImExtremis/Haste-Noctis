...
import {MEDIA_PROXY_PROFILE_BANNER_SIZE_POPOUT} from '@noctis/constants/src/MediaProxyAssetSizes';
import type {MediaProxyImageSize} from '@noctis/constants/src/MediaProxyImageSizes';
import type {UserProfile} from '@noctis/schema/src/domains/user/UserResponseSchemas';
