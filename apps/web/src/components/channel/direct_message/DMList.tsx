...
import {PublicUserFlags, RelationshipTypes} from '@noctis/constants/src/UserConstants';
import {formatShortRelativeTime} from '@noctis/date_utils/src/DateDuration';
import {extractTimestamp, fromTimestamp} from '@noctis/snowflake/src/SnowflakeUtils';
...
export const DMList = observer(() => {
	...
	const showMobileStellarButton = showPremiumFeatures && !isMobile;
			...
			<div className={styles.mobileContainer}>
				...
				<Scroller className={styles.mobileScroller} key="dm-list-mobile-scroller">
					<div className={styles.mobileScrollerContent}>
						...
						{showMobileStellarButton && (
							<FocusRing offset={-2}>
								<button
									type="button"
									onClick={() => PremiumModalActionCreators.open()}
									className={styles.mobileStellarButton}
								>
									<div className={styles.mobileSpecialButtonContent}>
										<div className={styles.mobileSpecialButtonIcon}>
