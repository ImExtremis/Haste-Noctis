...
import {MessageAttachmentFlags, MessageEmbedTypes, Permissions} from '@noctis/constants/src/ChannelConstants';
...
import type {MessageAttachment} from '@noctis/schema/src/domains/message/MessageResponseSchemas';
