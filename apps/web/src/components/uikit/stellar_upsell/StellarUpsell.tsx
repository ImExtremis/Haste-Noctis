...
import styles from '@app/components/uikit/stellar_upsell/StellarUpsell.module.css';
...
export const StellarUpsell: React.FC<StellarUpsellProps> = ({
	children,
	className,
	buttonText,
	onButtonClick,
		...
		<div className={clsx(styles.upsell, className)}>
			...
			<div className={styles.content}>
				...
				<div className={styles.actions}>
					...
					>
						{buttonText ?? <Trans>Get Stellar</Trans>}
					</Button>
