...
import {ME} from '@noctis/constants/src/AppConstants';
...
export const Endpoints = {
	...
	USER_E2E_PUBLIC_KEY: '/users/@me/e2e-public-key',
	...
	SUPPORT_APPEALS: '/support/appeals',
	...
	// D4: Poll system
	CHANNEL_POLLS: (channelId: string) => `/channels/${channelId}/polls`,
	POLL: (pollId: string) => `/polls/${pollId}`,
	POLL_VOTE: (pollId: string) => `/polls/${pollId}/vote`,
	POLL_END: (pollId: string) => `/polls/${pollId}/end`,

	// D6: Moderation case system
	GUILD_MOD_CASES: (guildId: string) => `/guilds/${guildId}/mod-cases`,
	GUILD_MOD_CASE: (guildId: string, caseId: string) => `/guilds/${guildId}/mod-cases/${caseId}`,
	GUILD_MOD_CASE_DISMISS: (guildId: string, caseId: string) => `/guilds/${guildId}/mod-cases/${caseId}/dismiss`,
	GUILD_MEMBER_WARN: (guildId: string, userId: string) => `/guilds/${guildId}/members/${userId}/warn`,
	GUILD_MOD_THRESHOLDS: (guildId: string) => `/guilds/${guildId}/automod-thresholds`,

	// D9: Notification system — per-guild and per-channel overrides
	GUILD_NOTIFICATION_OVERRIDE: (guildId: string) => `/users/@me/guilds/${guildId}/notification-override`,
	CHANNEL_NOTIFICATION_OVERRIDE: (channelId: string) => `/channels/${channelId}/notification-override`,
	USER_DND_SCHEDULE: '/users/@me/notification-dnd-schedule',
} as const;
