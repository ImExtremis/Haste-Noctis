...
import type {FederationOAuth2TokenResponse} from '@noctis/schema/src/domains/oauth2/FederationOAuth2Schemas';
...
class RemoteInstanceAuth {
	...
	async getOAuth2Config(instanceDomain: string, forceRefresh = false): Promise<OAuth2Config> {
		...
		const wellKnownUrl = `https://${instanceDomain}/.well-known/noctis`;
