...
import {SKIN_TONE_SURROGATES} from '@noctis/constants/src/EmojiConstants';
import {type EmojiProvider, setEmojiParserConfig} from '@noctis/markdown_parser/src/parsers/EmojiParsers';
