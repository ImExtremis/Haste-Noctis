...
const MEDIAPIPE_TASKS_VISION_WASM_BASE = `https://static.noctis.app/libs/mediapipe/tasks-vision/0.10.14/wasm`;
const MEDIAPIPE_SEGMENTER_MODEL_PATH =
	'https://static.noctis.app/libs/mediapipe/image_segmenter/selfie_segmenter/float16/latest/selfie_segmenter.tflite';
