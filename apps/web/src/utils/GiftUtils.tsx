...
export function getStellarDurationConfig(i18n: I18n): GiftDurationTextConfig {
	return {
		lifetime: i18n._(msg`Visionary (Lifetime Stellar)`),
		oneYear: i18n._(msg`1 Year of Stellar`),
		plural: (durationMonths: number) =>
			i18n._(
				durationMonths === 1 ? msg`${durationMonths} Month of Stellar` : msg`${durationMonths} Months of Stellar`,
			),
	};
}
...
export function getPremiumDurationConfig(i18n: I18n): GiftDurationTextConfig {
	return {
		lifetime: i18n._(msg`Lifetime Stellar`),
		oneYear: i18n._(msg`1 Year of Stellar`),
		plural: (durationMonths: number) =>
			i18n._(
				durationMonths === 1 ? msg`${durationMonths} Month of Stellar` : msg`${durationMonths} Months of Stellar`,
...
export function getGiftDurationText(i18n: I18n, gift: Gift | GiftDurationPayload): string {
	return formatGiftDurationText(gift.duration_months, getStellarDurationConfig(i18n));
}
