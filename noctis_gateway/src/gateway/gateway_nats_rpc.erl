...
do_connect(State) ->
    NatsUrl = noctis_gateway_env:get(nats_core_url),
    AuthToken = noctis_gateway_env:get(nats_auth_token),
...
max_handlers() ->
    case noctis_gateway_env:get(gateway_http_rpc_max_concurrency) of
