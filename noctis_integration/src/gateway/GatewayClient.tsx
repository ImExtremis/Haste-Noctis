...
import {Config} from '@noctis/integration/Config';
import type {
	GatewayDispatch,
	GatewayHelloPayload,
	GatewayPayload,
	...
	VoiceServerUpdate,
	VoiceStateUpdate,
} from '@noctis/integration/gateway/GatewayTypes';
import {GatewayOpcode} from '@noctis/integration/gateway/GatewayTypes';
...
export class GatewayClient {
	...
	private setupWebSocket(reject: (error: Error) => void, resumeState?: GatewayResumeState): void {
		...
		const headers: Record<string, string> = {
			'User-Agent': 'NoctisIntegrationTests/1.0',
		};
	...
	private sendIdentify(): void {
		this.send({
			...
			d: {
				...
				properties: {
					os: 'linux',
					browser: 'NoctisIntegrationTests',
					device: 'NoctisIntegrationTests',
				},
				compress: false,
				large_threshold: 250,
			},
