...
import type {TelemetryConfig} from '@noctis/telemetry/src/Telemetry';
import {createOtlpConfigFromTelemetryConfig} from '@noctis/telemetry/src/telemetry_runtime/TelemetryConfig';
import {createTelemetryInstrumentations} from '@noctis/telemetry/src/telemetry_runtime/TelemetryInstrumentations';
import type {ITelemetryInitLogger} from '@noctis/telemetry/src/telemetry_runtime/TelemetryLogger';
...
export async function createTelemetrySdk(config: TelemetryConfig, logger: ITelemetryInitLogger): Promise<NodeSDK> {
	...
	const resource = resourceFromAttributes({
		...
		[SEMRESATTRS_SERVICE_NAMESPACE]: 'noctis',
