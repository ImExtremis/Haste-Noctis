...
import {discoverControllerFiles, extractRoutesFromControllers} from '@noctis/openapi/src/extractors/RouteExtractor';
import {isExcludedRoutePath, OpenAPIGeneratorCatalog} from '@noctis/openapi/src/generator/OpenAPIGeneratorCatalog';
import {OpenAPIOperationBuilder} from '@noctis/openapi/src/generator/OpenAPIOperationBuilder';
import {collectReferencedSchemaNames} from '@noctis/openapi/src/generator/OpenAPISchemaReferenceCollector';
import {loadSchemasIntoRegistry} from '@noctis/openapi/src/generator/OpenAPISchemaRegistryLoader';
import type {OpenAPIGenerationResult, OpenAPIGeneratorOptions} from '@noctis/openapi/src/OpenAPIGenerationTypes';
import type {ExtractedRoute, OpenAPIDocument, OpenAPIPathItem, OpenAPISchema} from '@noctis/openapi/src/OpenAPITypes';
import {convertPathToOpenAPI} from '@noctis/openapi/src/registry/ParameterRegistry';
import {SchemaRegistry} from '@noctis/openapi/src/registry/SchemaRegistry';
...
function createGeneratorSettings(options: OpenAPIGeneratorOptions): GeneratorSettings {
	return {
		...
		title: options.title ?? 'Noctis API',
		version: options.version ?? '1.0.0',
		description: options.description ?? 'The Noctis API',
		serverUrl: options.serverUrl ?? 'https://api.noctis.app',
	};
}
	...
	public async generateWithStats(): Promise<OpenAPIGenerationResult> {
		...
		const document: OpenAPIDocument = {
			...
			info: {
				...
				contact: {
					name: 'Noctis Developers',
					email: 'developers@noctis.app',
				},
				license: {
					name: 'AGPL-3.0',
