...
import {OpenAPIGenerator} from '@noctis/openapi/src/OpenAPIGenerator';
import {printValidationResult, validateSpec} from '@noctis/openapi/src/output/SpecValidator';
import {getDefaultOutputPath, readSpec, writeSpec} from '@noctis/openapi/src/output/SpecWriter';
...
async function main(): Promise<void> {
	...
	console.log('Noctis OpenAPI Specification Generator');
	console.log('======================================');
	...
	try {
		const generator = new OpenAPIGenerator({
			...
			version: '1.0.0',
			description:
				'API for Noctis, a free and open source instant messaging and VoIP platform built for friends, groups, and communities.',
			serverUrl: 'https://api.noctis.app/v1',
		});
...
function runResourceOverviewGenerator(basePath: string): void {
	const scriptPath = path.join(basePath, 'noctis_docs/scripts/generate_resources.mjs');
