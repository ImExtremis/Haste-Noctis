...
import type {OpenAPISchema, OpenAPISecurityScheme} from '@noctis/openapi/src/OpenAPITypes';
import {ERROR_SCHEMA} from '@noctis/openapi/src/registry/ResponseRegistry';
