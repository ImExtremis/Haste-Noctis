...
import {createTestServer, readRequestBody, type TestServer} from '@noctis/http_client/src/__tests__/TestHttpServer';
import {createHttpClient} from '@noctis/http_client/src/HttpClient';
import type {
	HttpClientMetrics,
	HttpClientTelemetry,
	HttpClientTracing,
} from '@noctis/http_client/src/HttpClientTelemetryTypes';
import type {RequestUrlPolicy, RequestUrlValidationContext} from '@noctis/http_client/src/HttpClientTypes';
import {HttpError} from '@noctis/http_client/src/HttpError';
import {afterAll, beforeAll, describe, expect, it} from 'vitest';

const TEST_USER_AGENT = 'NoctisHttpClient/1.0 (Test)';
