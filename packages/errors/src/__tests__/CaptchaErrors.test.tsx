...
import {CaptchaRequiredError, InvalidCaptchaError} from '@noctis/errors/src/CaptchaErrors';
...
describe('CaptchaErrors', () => {
	describe('CaptchaRequiredError', () => {
		...
		it('should extend NoctisError', () => {
			const error = new CaptchaRequiredError();

			expect(error).toBeInstanceOf(NoctisError);
		});
