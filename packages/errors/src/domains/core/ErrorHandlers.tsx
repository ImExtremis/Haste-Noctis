...
import {OAuth2Error} from '@noctis/errors/src/domains/auth/OAuth2Error';
...
} from '@noctis/errors/src/error_handling/ErrorIntrospection';
import {createJsonErrorResponse} from '@noctis/errors/src/error_handling/ErrorResponse';
import {NoctisError} from '@noctis/errors/src/NoctisError';
import {ErrorCodeToI18nKey} from '@noctis/errors/src/i18n/ErrorCodeMappings';
import {getErrorMessage} from '@noctis/errors/src/i18n/ErrorI18n';
import type {ErrorI18nKey} from '@noctis/errors/src/i18n/ErrorI18nTypes.generated';
import type {BaseHonoEnv, ErrorI18nService} from '@noctis/hono_types/src/HonoTypes';
...
function handleNoctisError<E extends BaseHonoEnv>(err: NoctisError, ctx: Context<E>): Response {
...
export function AppErrorHandler<E extends BaseHonoEnv = BaseHonoEnv>(
	...
	if (!(err instanceof NoctisError || isExpectedError(err))) {
	...
	if (err instanceof NoctisError) {
		return handleNoctisError(err, ctx);
	}
