...
import {LIMIT_KEYS, type LimitKey} from '@noctis/constants/src/LimitConfigMetadata';
import type {ILimitConfigCodec, LimitConfigCodecOptions} from '@noctis/limits/src/ILimitConfigCodec';
