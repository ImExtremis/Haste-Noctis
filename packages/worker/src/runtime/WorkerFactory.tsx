...
import {setWorkerDependencies} from '@noctis/worker/src/context/WorkerContext';
...
import type {
	...
	WorkerQueueConfig,
	WorkerRuntimeConfig,
} from '@noctis/worker/src/contracts/WorkerTypes';
import type {IQueueProvider} from '@noctis/worker/src/providers/IQueueProvider';
import {WorkerRunner} from '@noctis/worker/src/runtime/WorkerRunner';
import {WorkerTaskRegistry} from '@noctis/worker/src/runtime/WorkerTaskRegistry';
import {WorkerService} from '@noctis/worker/src/services/WorkerService';
