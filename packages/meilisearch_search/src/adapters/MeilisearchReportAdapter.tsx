...
import {MeilisearchIndexAdapter} from '@noctis/meilisearch_search/src/adapters/MeilisearchIndexAdapter';
import {
	compactFilters,
	...
	meiliIsNotNull,
	meiliIsNull,
} from '@noctis/meilisearch_search/src/MeilisearchFilterUtils';
import {MEILISEARCH_INDEX_DEFINITIONS} from '@noctis/meilisearch_search/src/MeilisearchIndexDefinitions';
