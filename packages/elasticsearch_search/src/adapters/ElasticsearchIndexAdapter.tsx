...
import {compactFilters} from '@noctis/elasticsearch_search/src/ElasticsearchFilterUtils';
import type {ElasticsearchIndexDefinition} from '@noctis/elasticsearch_search/src/ElasticsearchIndexDefinitions';
