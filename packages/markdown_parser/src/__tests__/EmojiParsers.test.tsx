...
import {clearTestEmojiProvider, setupTestEmojiProvider} from '@noctis/markdown_parser/src/__tests__/TestEmojiSetup';
import {Parser} from '@noctis/markdown_parser/src/parser/Parser';
import {EmojiKind, NodeType, ParserFlags} from '@noctis/markdown_parser/src/types/Enums';
import type {EmojiNode, TextNode} from '@noctis/markdown_parser/src/types/Nodes';
...
describe('Noctis Markdown Parser', () => {
	test('standard emoji', () => {
