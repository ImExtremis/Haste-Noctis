...
import {ChannelNicknameOverrides} from '@noctis/schema/src/domains/channel/ChannelSchemas';
import {ChannelOverwriteTypeSchema, GeneralChannelNameType} from '@noctis/schema/src/primitives/ChannelValidators';
import {createBase64StringType} from '@noctis/schema/src/primitives/FileValidators';
import {QueryBooleanType} from '@noctis/schema/src/primitives/QueryValidators';
import {
	createNamedLiteral,
...
export const ChannelOverwriteRequest = z.object({
	...
	allow: UnsignedInt64Type.optional().describe('noctis:UnsignedInt64Type Bitwise value of allowed permissions'),
	deny: UnsignedInt64Type.optional().describe('noctis:UnsignedInt64Type Bitwise value of denied permissions'),
});
...
export const PermissionOverwriteCreateRequest = z.object({
	...
	allow: UnsignedInt64Type.nullish().describe('noctis:UnsignedInt64Type Bitwise value of allowed permissions'),
	deny: UnsignedInt64Type.nullish().describe('noctis:UnsignedInt64Type Bitwise value of denied permissions'),
});
