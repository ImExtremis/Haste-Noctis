...
import {type UserPartial, UserPartialResponse} from '@noctis/schema/src/domains/user/UserResponseSchemas';
import {ChannelOverwriteTypeSchema, ChannelTypeSchema} from '@noctis/schema/src/primitives/ChannelValidators';
import {PermissionStringType} from '@noctis/schema/src/primitives/PermissionValidators';
import {createStringType, Int32Type, SnowflakeStringType} from '@noctis/schema/src/primitives/SchemaPrimitives';
import {z} from 'zod';
...
export const ChannelOverwriteResponse = z.object({
	...
	allow: PermissionStringType.describe('noctis:PermissionStringType The bitwise value of allowed permissions'),
	deny: PermissionStringType.describe('noctis:PermissionStringType The bitwise value of denied permissions'),
});
