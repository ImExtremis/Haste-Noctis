...
import {RTC_REGION_ID_MAX_LENGTH, RTC_REGION_ID_MIN_LENGTH} from '@noctis/constants/src/LimitConstants';
import {ChannelResponse, RtcRegionResponse} from '@noctis/schema/src/domains/channel/ChannelSchemas';
import {GuildEmojiResponse, GuildStickerResponse} from '@noctis/schema/src/domains/guild/GuildEmojiSchemas';
import {GuildMemberResponse} from '@noctis/schema/src/domains/guild/GuildMemberSchemas';
import {GuildResponse} from '@noctis/schema/src/domains/guild/GuildResponseSchemas';
import {GuildRoleResponse} from '@noctis/schema/src/domains/guild/GuildRoleSchemas';
import {FavoriteMemeResponse} from '@noctis/schema/src/domains/meme/MemeSchemas';
import {CustomStatusPayload} from '@noctis/schema/src/domains/user/UserRequestSchemas';
import {
...
} from '@noctis/schema/src/domains/user/UserResponseSchemas';
import {createStringType, SnowflakeStringType, SnowflakeType} from '@noctis/schema/src/primitives/SchemaPrimitives';
import {z} from 'zod';
