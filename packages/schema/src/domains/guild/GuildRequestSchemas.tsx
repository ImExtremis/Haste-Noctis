...
import {VanityURLCodeType} from '@noctis/schema/src/primitives/ChannelValidators';
...
import {PasswordType} from '@noctis/schema/src/primitives/UserValidators';
import {z} from 'zod';
...
export const GuildRoleCreateRequest = z.object({
	...
	permissions: UnsignedInt64Type.optional().describe('noctis:UnsignedInt64Type The permissions bitfield for the role'),
});
