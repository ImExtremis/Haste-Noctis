...
import {MAX_INVITE_AGE_SECONDS, MAX_INVITE_USES} from '@noctis/constants/src/LimitConstants';
import {type Channel, ChannelPartialResponse} from '@noctis/schema/src/domains/channel/ChannelSchemas';
import {type Guild, GuildPartialResponse} from '@noctis/schema/src/domains/guild/GuildResponseSchemas';
import {PackType} from '@noctis/schema/src/domains/pack/PackSchemas';
import {UserPartialResponse} from '@noctis/schema/src/domains/user/UserResponseSchemas';
import {Int32Type, SnowflakeStringType} from '@noctis/schema/src/primitives/SchemaPrimitives';
import {z} from 'zod';
