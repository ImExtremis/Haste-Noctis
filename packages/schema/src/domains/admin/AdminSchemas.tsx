...
import {SystemChannelFlags, SystemChannelFlagsDescriptions} from '@noctis/constants/src/GuildConstants';
import {LIMIT_KEYS} from '@noctis/constants/src/LimitConfigMetadata';
import {ValidationErrorCodes} from '@noctis/constants/src/ValidationErrorCodes';
import {GuildAdminResponse} from '@noctis/schema/src/domains/admin/AdminGuildSchemas';
import {UserAdminResponseSchema} from '@noctis/schema/src/domains/admin/AdminUserSchemas';
import {GuildMemberResponse} from '@noctis/schema/src/domains/guild/GuildMemberSchemas';
import {ChannelTypeSchema} from '@noctis/schema/src/primitives/ChannelValidators';
import {
	...
	NSFWLevelSchema,
} from '@noctis/schema/src/primitives/GuildValidators';
import {PermissionStringType} from '@noctis/schema/src/primitives/PermissionValidators';
import {createQueryIntegerType} from '@noctis/schema/src/primitives/QueryValidators';
import {
...
import {EmailType, PhoneNumberType} from '@noctis/schema/src/primitives/UserValidators';
import {z} from 'zod';
...
const AdminGuildRoleSummarySchema = z.object({
	...
	color: Int32Type,
	position: Int32Type,
	permissions: PermissionStringType.describe('noctis:PermissionStringType The role permissions bitfield'),
	hoist: z.boolean(),
