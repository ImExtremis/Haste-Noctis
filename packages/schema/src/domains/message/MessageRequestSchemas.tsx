...
import {MessageFlags, MessageFlagsDescriptions} from '@noctis/constants/src/ChannelConstants';
import {
	ClientAttachmentReferenceRequest,
	ClientAttachmentRequest,
} from '@noctis/schema/src/domains/message/AttachmentSchemas';
import {AllowedMentionsRequest, MessageReferenceRequest} from '@noctis/schema/src/domains/message/SharedMessageSchemas';
import {createQueryIntegerType, DateTimeType} from '@noctis/schema/src/primitives/QueryValidators';
import {
	ColorType,
...
import {AttachmentURLType, URLType} from '@noctis/schema/src/primitives/UrlValidators';
import {z} from 'zod';
