...
import {MAX_REACTIONS_PER_MESSAGE} from '@noctis/constants/src/LimitConstants';
import type {GuildMemberData} from '@noctis/schema/src/domains/guild/GuildMemberSchemas';
import {type MessageEmbed, MessageEmbedResponse} from '@noctis/schema/src/domains/message/EmbedSchemas';
import {type UserPartial, UserPartialResponse} from '@noctis/schema/src/domains/user/UserResponseSchemas';
import {MessageReferenceTypeSchema, MessageTypeSchema} from '@noctis/schema/src/primitives/MessageValidators';
import {createBitflagInt32Type, Int32Type, SnowflakeStringType} from '@noctis/schema/src/primitives/SchemaPrimitives';
import {z} from 'zod';
