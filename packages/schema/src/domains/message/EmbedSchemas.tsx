...
import {EmbedMediaFlags, EmbedMediaFlagsDescriptions} from '@noctis/constants/src/ChannelConstants';
import {createBitflagInt32Type, Int32Type} from '@noctis/schema/src/primitives/SchemaPrimitives';
import {z} from 'zod';
