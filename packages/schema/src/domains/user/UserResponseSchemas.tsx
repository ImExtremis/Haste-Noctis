...
import {ConnectionResponse} from '@noctis/schema/src/domains/connection/ConnectionSchemas';
import {GuildMemberResponse} from '@noctis/schema/src/domains/guild/GuildMemberSchemas';
import {MessageResponseSchema} from '@noctis/schema/src/domains/message/MessageResponseSchemas';
...
export const UserPartialResponse = z.object({
	...
	/**
	 * The user's X25519 public key (raw bytes, base64-encoded) used for E2E encryption
	 * of direct messages. Null if the user has not set up E2E encryption.
	 */
	e2e_public_key: z.string().nullable().optional().describe(
		'The X25519 public key (base64-encoded) for end-to-end encrypted messaging. Null if not configured.',
	),
});
...
export interface UserPartial {
	...
	/** X25519 public key (base64-encoded) for E2E encrypted DMs. Null if not configured. */
	readonly e2e_public_key?: string | null;
}
