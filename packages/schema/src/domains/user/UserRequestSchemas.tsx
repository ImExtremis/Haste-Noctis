...
import {AVATAR_MAX_SIZE} from '@noctis/constants/src/LimitConstants';
import {StatusTypes} from '@noctis/constants/src/StatusConstants';
import {
...
import {SudoVerificationSchema} from '@noctis/schema/src/domains/auth/AuthSchemas';
import {isValidSingleUnicodeEmoji} from '@noctis/schema/src/primitives/EmojiValidators';
import {createBase64StringType} from '@noctis/schema/src/primitives/FileValidators';
import {LocaleSchema} from '@noctis/schema/src/primitives/LocaleSchema';
import {createQueryIntegerType, DateTimeType, QueryBooleanType} from '@noctis/schema/src/primitives/QueryValidators';
import {
	ColorType,
	...
	withOpenApiType,
} from '@noctis/schema/src/primitives/SchemaPrimitives';
import {URLType} from '@noctis/schema/src/primitives/UrlValidators';
import {
...
} from '@noctis/schema/src/primitives/UserSettingsValidators';
import {
	DiscriminatorType,
	EmailType,
	GlobalNameType,
	PasswordType,
	UsernameType,
} from '@noctis/schema/src/primitives/UserValidators';
import {z} from 'zod';
...
/**
 * Request body for updating the user's E2E encryption public key.
 * The public_key must be the raw X25519 public key bytes, base64-encoded (44 chars).
 */
export const E2EPublicKeyUpdateRequest = z.object({
	public_key: z
		.string()
		.min(40)
		.max(64)
		.regex(/^[A-Za-z0-9+/]+=*$/, 'public_key must be a valid base64-encoded string')
		.describe('The X25519 public key (raw bytes, base64-encoded) for E2E encrypted messaging'),
});
export type E2EPublicKeyUpdateRequest = z.infer<typeof E2EPublicKeyUpdateRequest>;
