...
import {SsoStatusResponse} from '@noctis/schema/src/domains/auth/AuthSchemas';
import {z} from 'zod';
...
export const WellKnownNoctisResponse = z.object({
	api_code_version: z.number().int().describe('Version of the API server code'),
	endpoints: z
		.object({
			api: z.string().describe('Base URL for authenticated API requests'),
...
export type WellKnownNoctisResponse = z.infer<typeof WellKnownNoctisResponse>;
