...
const NOCTIS_TAG_REGEX = /^[a-zA-Z0-9_]+$/;
...
export const UsernameType = withOpenApiType(
	z
		...
		.refine((value) => NOCTIS_TAG_REGEX.test(value), ValidationErrorCodes.USERNAME_INVALID_CHARACTERS)
		.refine((value) => {
		...
		.refine((value) => {
			const lowerValue = value.toLowerCase();
			return !lowerValue.includes('noctis') && !lowerValue.includes('system message');
