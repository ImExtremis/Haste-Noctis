...
import {compileTemplate} from '@noctis/i18n/src/runtime/CompileTemplate';
import {getEffectiveLocale} from '@noctis/i18n/src/runtime/GetEffectiveLocale';
import type {I18nResult, I18nState, TemplateCompiler} from '@noctis/i18n/src/runtime/I18nTypes';
import {loadLocaleIfNotLoaded} from '@noctis/i18n/src/runtime/LoadLocale';
