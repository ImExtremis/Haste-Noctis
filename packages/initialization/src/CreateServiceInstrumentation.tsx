...
import {startServiceInitialization} from '@noctis/initialization/src/Init';
import type {ShutdownFn} from '@noctis/initialization/src/ServiceInitializationTypes';
import type {InstrumentationConfig} from '@noctis/telemetry/src/Telemetry';
