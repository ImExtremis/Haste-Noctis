...
import {purgeAssets} from '@noctis/admin/src/api/Assets';
import {
	addSnowflakeReservation,
	deleteSnowflakeReservation,
	updateInstanceConfig,
} from '@noctis/admin/src/api/InstanceConfig';
import {getLimitConfig, updateLimitConfig} from '@noctis/admin/src/api/LimitConfig';
import {refreshSearchIndex, refreshSearchIndexWithGuild} from '@noctis/admin/src/api/Search';
import {reloadAllGuilds} from '@noctis/admin/src/api/System';
import {redirectWithFlash} from '@noctis/admin/src/middleware/Auth';
import {getFirstAccessiblePath} from '@noctis/admin/src/Navigation';
import {AssetPurgePage} from '@noctis/admin/src/pages/AssetPurgePage';
import {AuditLogsPage} from '@noctis/admin/src/pages/AuditLogsPage';
import {GatewayPage} from '@noctis/admin/src/pages/GatewayPage';
import {InstanceConfigPage} from '@noctis/admin/src/pages/InstanceConfigPage';
import {LimitConfigPage} from '@noctis/admin/src/pages/LimitConfigPage';
import {SearchIndexPage} from '@noctis/admin/src/pages/SearchIndexPage';
import {StrangePlacePage} from '@noctis/admin/src/pages/StrangePlacePage';
import {getRouteContext} from '@noctis/admin/src/routes/RouteContext';
import type {RouteFactoryDeps} from '@noctis/admin/src/routes/RouteTypes';
import {getPageConfig, isSelfHostedOverride} from '@noctis/admin/src/SelfHostedOverride';
import type {AppContext, AppVariables} from '@noctis/admin/src/types/App';
import {getOptionalString, type ParsedBody, parseDelimitedStringList} from '@noctis/admin/src/utils/Forms';
import {
