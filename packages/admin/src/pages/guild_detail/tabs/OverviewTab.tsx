...
import type {GuildChannel, GuildLookupResult, GuildRole} from '@noctis/admin/src/api/Guilds';
...
import {InfoGrid, InfoItem} from '@noctis/ui/src/components/Layout';
import {
	getGuildBannerUrl,
	getGuildEmbedSplashUrl,
	getGuildIconUrl,
	getGuildSplashUrl,
} from '@noctis/ui/src/utils/FormatUser';
import type {FC} from 'hono/jsx';

function getCurrentSnowflake(): string {
	const now = Date.now();
	const timestampOffset = now - NOCTIS_EPOCH;
