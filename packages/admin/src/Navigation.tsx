...
import {hasAnyPermission} from '@noctis/admin/src/AccessControlList';
import type {NavigationContext, NavSection} from '@noctis/admin/src/navigation/NavigationTypes';
