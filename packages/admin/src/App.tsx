...
import {createRequireAuth} from '@noctis/admin/src/middleware/Auth';
import {csrfMiddleware, initializeCsrf} from '@noctis/admin/src/middleware/Csrf';
import {createAdminErrorHandler} from '@noctis/admin/src/middleware/ErrorHandler';
import {resolveAdminPublicDir} from '@noctis/admin/src/PublicDir';
import {createAdminRoutes} from '@noctis/admin/src/routes/Admin';
import {createAuthRoutes} from '@noctis/admin/src/routes/Auth';
import {createBansRoutes} from '@noctis/admin/src/routes/Bans';
import {createCodesRoutes} from '@noctis/admin/src/routes/Codes';
import {createDiscoveryRoutes} from '@noctis/admin/src/routes/Discovery';
import {createGuildsRoutes} from '@noctis/admin/src/routes/Guilds';
import {createMessagesRoutes} from '@noctis/admin/src/routes/Messages';
import {createReportsRoutes} from '@noctis/admin/src/routes/Reports';
import type {RouteFactory} from '@noctis/admin/src/routes/RouteTypes';
import {createSystemRoutes} from '@noctis/admin/src/routes/System';
import {createUsersRoutes} from '@noctis/admin/src/routes/Users';
import {createVisionarySlotsRoutes} from '@noctis/admin/src/routes/VisionarySlots';
import {createVoiceRoutes} from '@noctis/admin/src/routes/Voice';
import type {AppVariables} from '@noctis/admin/src/types/App';
...
import {cacheHeaders} from '@noctis/hono/src/middleware/CacheHeaders';
...
export function createAdminApp(options: CreateAdminAppOptions): AdminAppResult {
	...
	if (!kvProvider) {
		throwKVRequiredError({
			...
			noctisServerHint: 'kvProvider is passed in as an option',
		});
	}
