...
import type {CaptchaProviderType, ICaptchaProvider, VerifyCaptchaParams} from '@noctis/captcha/src/ICaptchaProvider';
import type {LoggerInterface} from '@noctis/logger/src/LoggerInterface';
import {ms} from 'itty-time';

const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; Noctisbot/1.0; +https://noctis.app)';
