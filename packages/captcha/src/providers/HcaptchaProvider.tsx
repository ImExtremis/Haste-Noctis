...
import type {CaptchaProviderType} from '@noctis/captcha/src/ICaptchaProvider';
import {HttpCaptchaProvider} from '@noctis/captcha/src/providers/HttpCaptchaProvider';
