...
import type {IEmailI18nService} from '@noctis/email/src/EmailI18nService';
import type {EmailConfig, IEmailProvider, UserBouncedEmailChecker} from '@noctis/email/src/EmailProviderTypes';
import type {EmailTemplateVariables} from '@noctis/email/src/email_i18n/EmailI18nTypes';
import type {EmailTemplateKey} from '@noctis/email/src/email_i18n/EmailI18nTypes.generated';
...
export class EmailService implements IEmailService {
	...
	async sendNewLoginAlertEmail(
		...
		return this.sendTemplatedEmail(email, 'new_login_alert', locale, {
			username,
			ipAddress,
			userAgent,
			location,
