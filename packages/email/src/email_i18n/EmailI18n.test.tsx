...
import {getEmailTemplate, hasEmailLocale} from '@noctis/email/src/email_i18n/EmailI18n';
import type {EmailTemplate, EmailTemplateKey} from '@noctis/email/src/email_i18n/EmailI18nTypes.generated';
import type {I18nResult} from '@noctis/i18n/src/runtime/I18nTypes';
...
describe('EmailI18n', () => {
	...
	describe('constructor and initialization', () => {
		it('loads default templates from messages.yaml', () => {
			...
			expect(template.subject).toBe('Verify your Noctis email address');
	...
	describe('getTemplate() - basic retrieval', () => {
		it('returns template with subject and body', () => {
			...
			expect(template.subject).toBe('Reset your Noctis password');
	...
	describe('getTemplate() - variable interpolation', () => {
		it('always uses MessageFormat compilation', () => {
			...
			expect(template.subject).toBe('Your Noctis account has been temporarily suspended');
	...
	describe('getTemplate() - complex templates', () => {
		...
		it('handles scheduled deletion notification template', () => {
			...
			expect(template.subject).toBe('Your Noctis account will be permanently deleted');
	...
	describe('getTemplate() - caching and locale switching', () => {
		it('handles multiple template requests efficiently', () => {
			...
			expect(template1.subject).toBe('Verify your Noctis email address');
			expect(template2.subject).toBe('Reset your Noctis password');
		});
