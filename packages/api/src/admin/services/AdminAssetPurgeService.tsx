...
import {createEmojiID, createStickerID, type GuildID, type UserID} from '@noctis/api/src/BrandedTypes';
import {mapGuildEmojiToResponse, mapGuildStickerToResponse} from '@noctis/api/src/guild/GuildModel';
