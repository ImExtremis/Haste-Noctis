...
import type {AdminMessageShredService} from '@noctis/api/src/admin/services/AdminMessageShredService';
...
export class AdminMessageDeletionService {
	...
	async deleteAllUserMessages(
		...
		return await withBusinessSpan(
			'noctis.admin.message_bulk_delete',
			'noctis.admin.messages.bulk_deleted',
			{
			...
			async () => {
				...
				recordCounter({
					name: 'noctis.admin.messages.bulk_deleted_count',
					value: messageCount,
					dimensions: {
						user_id: data.user_id.toString(),
					},
