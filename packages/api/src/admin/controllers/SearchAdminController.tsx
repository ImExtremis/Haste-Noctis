...
import {SearchGuildsRequest} from '@noctis/schema/src/domains/admin/AdminGuildSchemas';
import {
...
import {SearchUsersRequest} from '@noctis/schema/src/domains/admin/AdminUserSchemas';
