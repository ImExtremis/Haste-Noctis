...
import type {BucketConfig} from '@noctis/rate_limit/src/IRateLimitService';
...
const TEST_ENABLE_RATE_LIMITS_HEADER = 'x-noctis-test-enable-rate-limits';
const TEST_GLOBAL_RATE_LIMIT_OVERRIDE_HEADER = 'x-noctis-test-global-rate-limit';
