...
import type {ChannelID, GuildID, MessageID, PhoneVerificationToken, UserID} from '@noctis/api/src/BrandedTypes';
import type {
	AuthSessionRow,
	EmailRevertTokenRow,
	...
	PhoneTokenRow,
} from '@noctis/api/src/database/types/AuthTypes';
import type {GiftCodeRow, PaymentBySubscriptionRow, PaymentRow} from '@noctis/api/src/database/types/PaymentTypes';
import type {
	PushSubscriptionRow,
	RecentMentionRow,
	RelationshipRow,
	...
	UserRow,
	UserSettingsRow,
} from '@noctis/api/src/database/types/UserTypes';
import type {AuthSession} from '@noctis/api/src/models/AuthSession';
import type {Channel} from '@noctis/api/src/models/Channel';
import type {EmailRevertToken} from '@noctis/api/src/models/EmailRevertToken';
import type {EmailVerificationToken} from '@noctis/api/src/models/EmailVerificationToken';
import type {GiftCode} from '@noctis/api/src/models/GiftCode';
import type {MfaBackupCode} from '@noctis/api/src/models/MfaBackupCode';
import type {PasswordResetToken} from '@noctis/api/src/models/PasswordResetToken';
import type {Payment} from '@noctis/api/src/models/Payment';
import type {PushSubscription} from '@noctis/api/src/models/PushSubscription';
import type {ReadState} from '@noctis/api/src/models/ReadState';
import type {RecentMention} from '@noctis/api/src/models/RecentMention';
import type {Relationship} from '@noctis/api/src/models/Relationship';
import type {SavedMessage} from '@noctis/api/src/models/SavedMessage';
...
import type {UserNote} from '@noctis/api/src/models/UserNote';
import type {UserSettings} from '@noctis/api/src/models/UserSettings';
import type {VisionarySlot} from '@noctis/api/src/models/VisionarySlot';
import type {WebAuthnCredential} from '@noctis/api/src/models/WebAuthnCredential';
...
} from '@noctis/api/src/user/repositories/IUserChannelRepository';
import type {IUserRepositoryAggregate} from '@noctis/api/src/user/repositories/IUserRepositoryAggregate';
import {UserAccountRepository} from '@noctis/api/src/user/repositories/UserAccountRepository';
import {UserAuthRepository} from '@noctis/api/src/user/repositories/UserAuthRepository';
import {UserChannelRepository} from '@noctis/api/src/user/repositories/UserChannelRepository';
import {UserContentRepository} from '@noctis/api/src/user/repositories/UserContentRepository';
import {UserRelationshipRepository} from '@noctis/api/src/user/repositories/UserRelationshipRepository';
import {UserSettingsRepository} from '@noctis/api/src/user/repositories/UserSettingsRepository';
...
export class UserRepository implements IUserRepositoryAggregate {
	...
	async checkAndRecordDevice(userId: UserID, deviceHash: string): Promise<boolean> {
		return this.authRepo.checkAndRecordDevice(userId, deviceHash);
	}
