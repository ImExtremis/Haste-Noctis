...
import type {PhoneVerificationToken, UserID} from '@noctis/api/src/BrandedTypes';
import type {
	AuthSessionRow,
	EmailRevertTokenRow,
...
import {IpAuthorizationRepository} from '@noctis/api/src/user/repositories/auth/IpAuthorizationRepository';
import {MfaBackupCodeRepository} from '@noctis/api/src/user/repositories/auth/MfaBackupCodeRepository';
import {TokenRepository} from '@noctis/api/src/user/repositories/auth/TokenRepository';
import {WebAuthnRepository} from '@noctis/api/src/user/repositories/auth/WebAuthnRepository';
import {UserDeviceRepository} from '@noctis/api/src/user/repositories/auth/UserDeviceRepository';
import type {IUserAccountRepository} from '@noctis/api/src/user/repositories/IUserAccountRepository';
import type {IUserAuthRepository} from '@noctis/api/src/user/repositories/IUserAuthRepository';
...
export class UserAuthRepository implements IUserAuthRepository {
	...
	async checkAndRecordDevice(userId: UserID, deviceHash: string): Promise<boolean> {
		return this.userDeviceRepository.checkAndRecordDevice(userId, deviceHash);
	}
}
