...
import type {AuthSessionRow} from '@noctis/api/src/database/types/AuthTypes';
import {AuthSession} from '@noctis/api/src/models/AuthSession';
import {AuthSessions, AuthSessionsByUserId} from '@noctis/api/src/Tables';
