...
import {createMessageID, createUserID, type MessageID, type UserID} from '@noctis/api/src/BrandedTypes';
...
import type {FavoriteMemeRepository} from '@noctis/api/src/favorite_meme/FavoriteMemeRepository';
...
import type {ApplicationRepository} from '@noctis/api/src/oauth/repositories/ApplicationRepository';
import type {OAuth2TokenRepository} from '@noctis/api/src/oauth/repositories/OAuth2TokenRepository';
