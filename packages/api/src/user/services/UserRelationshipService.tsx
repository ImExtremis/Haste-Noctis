...
import {mapRelationshipToResponse} from '@noctis/api/src/user/UserMappers';
import type {UserPermissionUtils} from '@noctis/api/src/utils/UserPermissionUtils';
import type {LimitKey} from '@noctis/constants/src/LimitConfigMetadata';
import {MAX_RELATIONSHIPS} from '@noctis/constants/src/LimitConstants';
import {RelationshipTypes, UserFlags} from '@noctis/constants/src/UserConstants';
import {BotsCannotSendFriendRequestsError} from '@noctis/errors/src/domains/oauth/BotsCannotSendFriendRequestsError';
import {AlreadyFriendsError} from '@noctis/errors/src/domains/user/AlreadyFriendsError';
import {CannotSendFriendRequestToBlockedUserError} from '@noctis/errors/src/domains/user/CannotSendFriendRequestToBlockedUserError';
import {CannotSendFriendRequestToSelfError} from '@noctis/errors/src/domains/user/CannotSendFriendRequestToSelfError';
import {FriendRequestBlockedError} from '@noctis/errors/src/domains/user/FriendRequestBlockedError';
import {InvalidDiscriminatorError} from '@noctis/errors/src/domains/user/InvalidDiscriminatorError';
import {MaxRelationshipsError} from '@noctis/errors/src/domains/user/MaxRelationshipsError';
import {NoUsersWithNoctistagError} from '@noctis/errors/src/domains/user/NoUsersWithNoctistagError';
import {UnclaimedAccountCannotAcceptFriendRequestsError} from '@noctis/errors/src/domains/user/UnclaimedAccountCannotAcceptFriendRequestsError';
import {UnclaimedAccountCannotSendFriendRequestsError} from '@noctis/errors/src/domains/user/UnclaimedAccountCannotSendFriendRequestsError';
import {UnknownUserError} from '@noctis/errors/src/domains/user/UnknownUserError';
import type {FriendRequestByTagRequest} from '@noctis/schema/src/domains/user/UserRequestSchemas';
...
export class UserRelationshipService {
	...
	async sendFriendRequestByTag({
		...
		if (!targetUser) {
			throw new NoUsersWithNoctistagError();
		}
