...
import {type ChannelID, createChannelID, createGuildID, type GuildID, type UserID} from '@noctis/api/src/BrandedTypes';
import type {ChannelOverride, UserGuildSettingsRow} from '@noctis/api/src/database/types/UserTypes';
...
import {ValidationError} from '@noctis/errors/src/ValidationError';
import type {
		...
		if (data.theme !== undefined) {
			if (data.theme !== currentSettings.theme) {
				getMetricsService().counter({
					name: 'noctis.users.theme_changed',
					dimensions: {
