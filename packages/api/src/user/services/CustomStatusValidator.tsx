...
import {createEmojiID, type EmojiID, type UserID} from '@noctis/api/src/BrandedTypes';
...
import type {CustomStatusPayload} from '@noctis/schema/src/domains/user/UserRequestSchemas';
