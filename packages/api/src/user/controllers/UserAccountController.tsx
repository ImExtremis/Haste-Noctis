...
import {DefaultUserOnly, LoginRequired, LoginRequiredAllowSuspicious} from '@noctis/api/src/middleware/AuthMiddleware';
import {requireOAuth2ScopeForBearer} from '@noctis/api/src/middleware/OAuth2ScopeMiddleware';
...
import type {UserUpdateWithVerificationRequestData} from '@noctis/api/src/user/services/UserAccountRequestService';
...
import {UserSettingsUpdateRequest} from '@noctis/api/src/user/UserModel';
...
import {
	...
	TargetIdParam,
	UserIdParam,
} from '@noctis/schema/src/domains/common/CommonParamSchemas';
import {
