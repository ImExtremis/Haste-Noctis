...
import {UserIdParam} from '@noctis/schema/src/domains/common/CommonParamSchemas';
import {
...
import {RelationshipResponse} from '@noctis/schema/src/domains/user/UserResponseSchemas';
import {z} from 'zod';
