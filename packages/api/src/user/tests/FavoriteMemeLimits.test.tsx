...
} from '@noctis/api/src/channel/tests/AttachmentTestUtils';
...
import {
	...
	listFavoriteMemes,
} from '@noctis/api/src/user/tests/FavoriteMemeTestUtils';
...
describe('Favorite Meme Limits', () => {
	...
	test('should return error for message without media', async () => {
		...
		const {sendMessage} = await import('@noctis/api/src/message/tests/MessageTestUtils');
