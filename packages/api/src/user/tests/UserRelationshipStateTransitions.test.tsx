...
import {createTestAccount, unclaimAccount} from '@noctis/api/src/auth/tests/AuthTestUtils';
...
import {fetchUserMe} from '@noctis/api/src/user/tests/UserTestUtils';
	...
	describe('error paths', () => {
		...
		test('friend request by tag with non-existent user', async () => {
			...
			await createBuilder(harness, alice.token)
				...
				.expect(HTTP_STATUS.BAD_REQUEST, 'NO_USERS_WITH_NOCTISTAG_EXIST')
				.execute();
		});
