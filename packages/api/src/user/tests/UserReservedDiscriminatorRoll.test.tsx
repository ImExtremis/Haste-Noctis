...
import {
	...
	registerUser,
} from '@noctis/api/src/auth/tests/AuthTestUtils';
...
import {TEST_CREDENTIALS, TEST_USER_DATA} from '@noctis/api/src/test/TestConstants';
import {createBuilder} from '@noctis/api/src/test/TestRequestBuilder';
import {grantPremium, updateUserProfile} from '@noctis/api/src/user/tests/UserTestUtils';
import {NON_SELF_HOSTED_RESERVED_DISCRIMINATORS} from '@noctis/constants/src/DiscriminatorConstants';
...
import type {UserPrivateResponse} from '@noctis/schema/src/domains/user/UserResponseSchemas';
