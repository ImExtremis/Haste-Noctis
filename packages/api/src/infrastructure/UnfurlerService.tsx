...
import {IUnfurlerService} from '@noctis/api/src/infrastructure/IUnfurlerService';
import {Logger} from '@noctis/api/src/Logger';
import {AudioResolver} from '@noctis/api/src/unfurler/resolvers/AudioResolver';
import type {BaseResolver} from '@noctis/api/src/unfurler/resolvers/BaseResolver';
import {BlueskyResolver} from '@noctis/api/src/unfurler/resolvers/BlueskyResolver';
import {DefaultResolver} from '@noctis/api/src/unfurler/resolvers/DefaultResolver';
import {HackerNewsResolver} from '@noctis/api/src/unfurler/resolvers/HackerNewsResolver';
import {ImageResolver} from '@noctis/api/src/unfurler/resolvers/ImageResolver';
import {KlipyResolver} from '@noctis/api/src/unfurler/resolvers/KlipyResolver';
import {TenorResolver} from '@noctis/api/src/unfurler/resolvers/TenorResolver';
import {VideoResolver} from '@noctis/api/src/unfurler/resolvers/VideoResolver';
import {WikipediaResolver} from '@noctis/api/src/unfurler/resolvers/WikipediaResolver';
import {XkcdResolver} from '@noctis/api/src/unfurler/resolvers/XkcdResolver';
import {YouTubeResolver} from '@noctis/api/src/unfurler/resolvers/YouTubeResolver';
import * as FetchUtils from '@noctis/api/src/utils/FetchUtils';
import type {ICacheService} from '@noctis/cache/src/ICacheService';
import {NOCTIS_USER_AGENT} from '@noctis/constants/src/Core';
import type {MessageEmbedResponse} from '@noctis/schema/src/domains/message/EmbedSchemas';
...
export class UnfurlerService extends IUnfurlerService {
	...
	private static readonly UNFURL_REQUEST_HEADERS = {'User-Agent': NOCTIS_USER_AGENT};
