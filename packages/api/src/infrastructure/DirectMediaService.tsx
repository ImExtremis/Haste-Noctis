...
} from '@noctis/api/src/infrastructure/IMediaService';
import {ExplicitContentCannotBeSentError} from '@noctis/errors/src/domains/moderation/ExplicitContentCannotBeSentError';
import type {LoggerInterface} from '@noctis/logger/src/LoggerInterface';
import type {IFrameService, IMetadataService} from '@noctis/media_proxy/src/types/MediaProxyServices';
import {
	createExternalMediaProxyUrlBuilder,
	type IExternalMediaProxyUrlBuilder,
} from '@noctis/media_proxy_utils/src/ExternalMediaProxyUrlBuilder';
