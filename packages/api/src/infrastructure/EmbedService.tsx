...
import type {ChannelID, MessageID} from '@noctis/api/src/BrandedTypes';
import type {RichEmbedMediaWithMetadata} from '@noctis/api/src/channel/EmbedTypes';
import type {IChannelRepository} from '@noctis/api/src/channel/IChannelRepository';
import {nextVersion} from '@noctis/api/src/database/Cassandra';
import type {MessageEmbed, MessageEmbedChild} from '@noctis/api/src/database/types/MessageTypes';
import type {IMediaService} from '@noctis/api/src/infrastructure/IMediaService';
import type {IUnfurlerService} from '@noctis/api/src/infrastructure/IUnfurlerService';
import {Embed} from '@noctis/api/src/models/Embed';
import {EmbedAuthor} from '@noctis/api/src/models/EmbedAuthor';
import {EmbedField} from '@noctis/api/src/models/EmbedField';
import {EmbedFooter} from '@noctis/api/src/models/EmbedFooter';
import {EmbedMedia} from '@noctis/api/src/models/EmbedMedia';
import * as UnfurlerUtils from '@noctis/api/src/utils/UnfurlerUtils';
import type {ICacheService} from '@noctis/cache/src/ICacheService';
import {EmbedMediaFlags} from '@noctis/constants/src/ChannelConstants';
...
import type {MessageEmbedChildResponse, MessageEmbedResponse} from '@noctis/schema/src/domains/message/EmbedSchemas';
import type {
	RichEmbedAuthorRequest,
	RichEmbedFooterRequest,
	RichEmbedMediaRequest,
	RichEmbedRequest,
} from '@noctis/schema/src/domains/message/MessageRequestSchemas';
