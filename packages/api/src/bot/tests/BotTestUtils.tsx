...
import {createUniqueEmail, createUniqueUsername, registerUser} from '@noctis/api/src/auth/tests/AuthTestUtils';
...
import type {ApplicationResponse} from '@noctis/schema/src/domains/oauth/OAuthSchemas';
