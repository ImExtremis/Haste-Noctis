...
import {generateUsernameSuggestions} from '@noctis/api/src/utils/UsernameSuggestionUtils';
...
export class AuthRequestService {
	...
	async terminateOtherSessions(userId: UserID, currentToken: string): Promise<void> {
		await this.authService.terminateOtherSessions(userId, currentToken);
	}

	async scheduleAccountDeletion(user: User): Promise<void> {
		await this.authService.scheduleAccountDeletion(user);
	}

	async cancelAccountDeletion(user: User): Promise<void> {
		await this.authService.cancelAccountDeletion(user);
	}
