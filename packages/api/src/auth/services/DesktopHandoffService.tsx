...
import {HandoffCodeExpiredError} from '@noctis/errors/src/domains/auth/HandoffCodeExpiredError';
import {InvalidHandoffCodeError} from '@noctis/errors/src/domains/auth/InvalidHandoffCodeError';
