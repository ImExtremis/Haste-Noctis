...
import {TotpGenerator} from '@noctis/api/src/utils/TotpGenerator';
...
import {InvalidWebAuthnAuthenticationCounterError} from '@noctis/errors/src/domains/auth/InvalidWebAuthnAuthenticationCounterError';
import {InvalidWebAuthnCredentialCounterError} from '@noctis/errors/src/domains/auth/InvalidWebAuthnCredentialCounterError';
import {InvalidWebAuthnCredentialError} from '@noctis/errors/src/domains/auth/InvalidWebAuthnCredentialError';
import {InvalidWebAuthnPublicKeyFormatError} from '@noctis/errors/src/domains/auth/InvalidWebAuthnPublicKeyFormatError';
import {NoPasskeysRegisteredError} from '@noctis/errors/src/domains/auth/NoPasskeysRegisteredError';
import {PasskeyAuthenticationFailedError} from '@noctis/errors/src/domains/auth/PasskeyAuthenticationFailedError';
import {PhoneRequiredForSmsMfaError} from '@noctis/errors/src/domains/auth/PhoneRequiredForSmsMfaError';
import {SmsMfaNotEnabledError} from '@noctis/errors/src/domains/auth/SmsMfaNotEnabledError';
import {SmsMfaRequiresTotpError} from '@noctis/errors/src/domains/auth/SmsMfaRequiresTotpError';
import {SmsVerificationUnavailableError} from '@noctis/errors/src/domains/auth/SmsVerificationUnavailableError';
import {UnknownWebAuthnCredentialError} from '@noctis/errors/src/domains/auth/UnknownWebAuthnCredentialError';
import {WebAuthnCredentialLimitReachedError} from '@noctis/errors/src/domains/auth/WebAuthnCredentialLimitReachedError';
