...
import {createPhoneVerificationToken, type UserID} from '@noctis/api/src/BrandedTypes';
...
import {SuspiciousActivityFlags, UserAuthenticatorTypes, UserFlags} from '@noctis/constants/src/UserConstants';
import {InvalidPhoneNumberError} from '@noctis/errors/src/domains/auth/InvalidPhoneNumberError';
import {InvalidPhoneVerificationCodeError} from '@noctis/errors/src/domains/auth/InvalidPhoneVerificationCodeError';
import {PhoneAlreadyUsedError} from '@noctis/errors/src/domains/auth/PhoneAlreadyUsedError';
import {PhoneVerificationRequiredError} from '@noctis/errors/src/domains/auth/PhoneVerificationRequiredError';
import {SmsMfaNotEnabledError} from '@noctis/errors/src/domains/auth/SmsMfaNotEnabledError';
import {PHONE_E164_REGEX} from '@noctis/schema/src/primitives/UserValidators';
