...
import {BotUserAuthEndpointAccessDeniedError} from '@noctis/errors/src/domains/auth/BotUserAuthEndpointAccessDeniedError';
import {AccountPermanentlySuspendedError} from '@noctis/errors/src/domains/user/AccountPermanentlySuspendedError';
import {AccountTemporarilySuspendedError} from '@noctis/errors/src/domains/user/AccountTemporarilySuspendedError';
