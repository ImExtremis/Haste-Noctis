...
import {createPasswordResetToken} from '@noctis/api/src/BrandedTypes';
...
} from '@noctis/api/src/utils/PasswordUtils';
...
import type {ForgotPasswordRequest, ResetPasswordRequest} from '@noctis/schema/src/domains/auth/AuthSchemas';
