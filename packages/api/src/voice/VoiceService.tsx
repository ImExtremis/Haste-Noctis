...
import type {LiveKitService} from '@noctis/api/src/infrastructure/LiveKitService';
import type {PinnedRoomServer, VoiceRoomStore} from '@noctis/api/src/infrastructure/VoiceRoomStore';
...
import type {VoiceRegionAvailability, VoiceServerRecord} from '@noctis/api/src/voice/VoiceModel';
import {resolveVoiceRegionPreference, selectVoiceRegionId} from '@noctis/api/src/voice/VoiceRegionSelection';
import {generateConnectionId} from '@noctis/api/src/words/Words';
import {ChannelTypes} from '@noctis/constants/src/ChannelConstants';
import {UnclaimedAccountCannotJoinOneOnOneVoiceCallsError} from '@noctis/errors/src/domains/channel/UnclaimedAccountCannotJoinOneOnOneVoiceCallsError';
import {UnclaimedAccountCannotJoinVoiceChannelsError} from '@noctis/errors/src/domains/channel/UnclaimedAccountCannotJoinVoiceChannelsError';
