...
import * as InviteUtils from '@noctis/api/src/utils/InviteUtils';
import {URL_REGEX} from '@noctis/constants/src/Core';
...
export function isNoctisAppExcludedURL(url: string) {
	try {
		const parsedUrl = new URL(url);
...
export function extractURLs(inputText: string) {
	...
	for (const url of urls) {
		...
		if (isNoctisAppExcludedURL(url)) continue;
