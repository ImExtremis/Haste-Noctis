...
import {createTestAccount as authCreateTestAccount, type TestAccount} from '@noctis/api/src/auth/tests/AuthTestUtils';
...
export async function createMessageHarness(): Promise<ApiTestHarness> {
	const {createApiTestHarness} = await import('@noctis/api/src/test/ApiTestHarness');
