...
import type {ChannelID, GuildID, MessageID, ReportID, UserID} from '@noctis/api/src/BrandedTypes';
import {
	createChannelID,
	createGuildID,
	createInviteCode,
...
import * as MessageHelpers from '@noctis/api/src/channel/services/message/MessageHelpers';
import type {MessageAttachment} from '@noctis/api/src/database/types/MessageTypes';
import type {DSAReportTicketRow} from '@noctis/api/src/database/types/ReportTypes';
...
import type {IInviteRepository} from '@noctis/api/src/invite/IInviteRepository';
import {Logger} from '@noctis/api/src/Logger';
import type {Attachment} from '@noctis/api/src/models/Attachment';
...
import type {
	...
	IARSubmissionRow,
	IReportRepository,
} from '@noctis/api/src/report/IReportRepository';
import {ReportStatus, ReportType} from '@noctis/api/src/report/IReportRepository';
...
import {CannotReportOwnMessageError} from '@noctis/errors/src/domains/channel/CannotReportOwnMessageError';
import {UnknownChannelError} from '@noctis/errors/src/domains/channel/UnknownChannelError';
...
import {RateLimitError} from '@noctis/errors/src/domains/core/RateLimitError';
import {CannotReportOwnGuildError} from '@noctis/errors/src/domains/guild/CannotReportOwnGuildError';
...
import {CannotReportYourselfError} from '@noctis/errors/src/domains/moderation/CannotReportYourselfError';
import {InvalidDsaReportTargetError} from '@noctis/errors/src/domains/moderation/InvalidDsaReportTargetError';
import {InvalidDsaTicketError} from '@noctis/errors/src/domains/moderation/InvalidDsaTicketError';
import {InvalidDsaVerificationCodeError} from '@noctis/errors/src/domains/moderation/InvalidDsaVerificationCodeError';
import {ReportBannedError} from '@noctis/errors/src/domains/moderation/ReportBannedError';
import {UnknownReportError} from '@noctis/errors/src/domains/moderation/UnknownReportError';
import {UnknownUserError} from '@noctis/errors/src/domains/user/UnknownUserError';
import type {DsaReportRequest} from '@noctis/schema/src/domains/report/ReportSchemas';
...
export class ReportService {
	...
	private async findUserByTag(tag: string): Promise<User> {
		const parsed = this.parseNoctisTag(tag);
		if (!parsed) {
			throw new InvalidDsaReportTargetError();
		}
	...
	private parseNoctisTag(tag: string): {username: string; discriminator: number} | null {
