...
import {createInviteCode, vanityCodeToInviteCode} from '@noctis/api/src/BrandedTypes';
...
import {Invite} from '@noctis/api/src/models/Invite';
...
import {ChannelTypes, InviteTypes, Permissions} from '@noctis/constants/src/ChannelConstants';
import {GuildFeatures, GuildOperations, JoinSourceTypes} from '@noctis/constants/src/GuildConstants';
import {MAX_GUILD_INVITES} from '@noctis/constants/src/LimitConstants';
import {UnclaimedAccountCannotJoinGroupDmsError} from '@noctis/errors/src/domains/channel/UnclaimedAccountCannotJoinGroupDmsError';
...
import {MaxGuildInvitesError} from '@noctis/errors/src/domains/guild/MaxGuildInvitesError';
import {InvitesDisabledError} from '@noctis/errors/src/domains/invite/InvitesDisabledError';
import {TemporaryInviteRequiresPresenceError} from '@noctis/errors/src/domains/invite/TemporaryInviteRequiresPresenceError';
...
export class InviteService {
	...
	async acceptInvite({userId, inviteCode, requestCache}: AcceptInviteParams): Promise<Invite> {
		return await withBusinessSpan('noctis.guild.join', 'noctis.guilds.joined', {}, () =>
