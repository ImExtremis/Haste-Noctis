...
import {DonationAmountInvalidError} from '@noctis/errors/src/domains/donation/DonationAmountInvalidError';
			...
			const lineItem: Stripe.Checkout.SessionCreateParams.LineItem = isRecurring
				? {
						price_data: {
							...
							product_data: {
								name: 'Noctis Recurring Donation',
								description: `${params.interval === 'month' ? 'Monthly' : 'Yearly'} donation to support Noctis`,
							},
				...
				: {
						price_data: {
							currency: params.currency,
							product_data: {
								name: 'Noctis Donation',
								description: 'One-time donation to support Noctis',
							},
							unit_amount: params.amountCents,
						},
						quantity: 1,
