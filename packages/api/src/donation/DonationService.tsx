...
import type {IDonationService} from '@noctis/api/src/donation/IDonationService';
import type {DonationCheckoutService} from '@noctis/api/src/donation/services/DonationCheckoutService';
import type {DonationMagicLinkService} from '@noctis/api/src/donation/services/DonationMagicLinkService';
