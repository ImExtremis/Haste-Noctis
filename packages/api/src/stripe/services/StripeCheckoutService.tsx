...
import type {ProductRegistry} from '@noctis/api/src/stripe/ProductRegistry';
import type {IUserRepository} from '@noctis/api/src/user/IUserRepository';
import {type Currency, getCurrency} from '@noctis/api/src/utils/CurrencyUtils';
import {UserFlags, UserPremiumTypes} from '@noctis/constants/src/UserConstants';
import {PremiumPurchaseBlockedError} from '@noctis/errors/src/domains/payment/PremiumPurchaseBlockedError';
import {StripeError} from '@noctis/errors/src/domains/payment/StripeError';
import {StripeInvalidProductConfigurationError} from '@noctis/errors/src/domains/payment/StripeInvalidProductConfigurationError';
import {StripeInvalidProductError} from '@noctis/errors/src/domains/payment/StripeInvalidProductError';
import {StripeNoPurchaseHistoryError} from '@noctis/errors/src/domains/payment/StripeNoPurchaseHistoryError';
import {StripePaymentNotAvailableError} from '@noctis/errors/src/domains/payment/StripePaymentNotAvailableError';
import {UnclaimedAccountCannotMakePurchasesError} from '@noctis/errors/src/domains/user/UnclaimedAccountCannotMakePurchasesError';
