...
import {getGuildMemberSearchService} from '@noctis/api/src/SearchFactory';
...
import type {SearchableGuildMember} from '@noctis/schema/src/contracts/search/SearchDocumentTypes';
...
} from '@noctis/schema/src/domains/guild/GuildMemberSearchSchemas';
