...
import {createGuildID, createStickerID} from '@noctis/api/src/BrandedTypes';
...
import {GuildIdParam, GuildIdStickerIdParam} from '@noctis/schema/src/domains/common/CommonParamSchemas';
