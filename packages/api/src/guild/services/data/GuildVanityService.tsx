...
import {InviteTypes, Permissions} from '@noctis/constants/src/ChannelConstants';
...
import type {GuildVanityURLResponse} from '@noctis/schema/src/domains/guild/GuildResponseSchemas';
...
export class GuildVanityService {
	...
	async updateVanityURL(
		...
		if (code?.includes('noctis')) {
			throw InputValidationError.fromCode('code', ValidationErrorCodes.VANITY_URL_CODE_CANNOT_CONTAIN_NOCTIS);
		}
