...
import {createChannelID, createGuildID, guildIdToRoleId} from '@noctis/api/src/BrandedTypes';
...
import {BatchBuilder} from '@noctis/api/src/database/Cassandra';
import type {GuildRow} from '@noctis/api/src/database/types/GuildTypes';
import {mapGuildToGuildResponse, mapGuildToPartialResponse} from '@noctis/api/src/guild/GuildModel';
...
import type {GuildDataHelpers} from '@noctis/api/src/guild/services/data/GuildDataHelpers';
...
import {Guild} from '@noctis/api/src/models/Guild';
...
import {
	...
	GuildRoles,
	Guilds,
} from '@noctis/api/src/Tables';
import {withBusinessSpan} from '@noctis/api/src/telemetry/BusinessSpans';
import {withSpan} from '@noctis/api/src/telemetry/Tracing';
import type {IUserRepository} from '@noctis/api/src/user/IUserRepository';
import {mapUserSettingsToResponse} from '@noctis/api/src/user/UserMappers';
...
import {ChannelTypes, DEFAULT_PERMISSIONS, Permissions} from '@noctis/constants/src/ChannelConstants';
import {
	GuildFeatures,
	...
	JoinSourceTypes,
	SystemChannelFlags,
} from '@noctis/constants/src/GuildConstants';
import {MAX_GUILDS_NON_PREMIUM} from '@noctis/constants/src/LimitConstants';
import {DEFAULT_GUILD_FOLDER_ICON, UNCATEGORIZED_FOLDER_ID} from '@noctis/constants/src/UserConstants';
...
import type {GuildPartialResponse, GuildResponse} from '@noctis/schema/src/domains/guild/GuildResponseSchemas';
import {extractTimestamp} from '@noctis/snowflake/src/SnowflakeUtils';
...
export class GuildOperationsService {
	...
	async createGuild(
		...
		return await withBusinessSpan('noctis.guild.create', 'noctis.guilds.created', {}, () =>
