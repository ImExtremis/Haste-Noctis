...
import type {ChannelID, EmojiID, GuildID, InviteCode, RoleID, StickerID, UserID} from '@noctis/api/src/BrandedTypes';
import {createUserID, createWebhookID} from '@noctis/api/src/BrandedTypes';
...
import {GuildChannelService} from '@noctis/api/src/guild/services/GuildChannelService';
import {GuildContentService} from '@noctis/api/src/guild/services/GuildContentService';
import {GuildDataService} from '@noctis/api/src/guild/services/GuildDataService';
import {GuildMemberService} from '@noctis/api/src/guild/services/GuildMemberService';
import {GuildModerationService} from '@noctis/api/src/guild/services/GuildModerationService';
import {GuildRoleService} from '@noctis/api/src/guild/services/GuildRoleService';
import {GuildSearchService} from '@noctis/api/src/guild/services/GuildSearchService';
...
import type {GuildAuditLog} from '@noctis/api/src/models/GuildAuditLog';
...
import {getCachedUserPartialResponses} from '@noctis/api/src/user/UserCacheHelpers';
...
import {MissingAccessError} from '@noctis/errors/src/domains/core/MissingAccessError';
...
import type {GuildBanResponse, GuildMemberResponse} from '@noctis/schema/src/domains/guild/GuildMemberSchemas';
import type {
	GuildCreateRequest,
...
import type {GuildRoleResponse} from '@noctis/schema/src/domains/guild/GuildRoleSchemas';
...
export class GuildService {
	...
	async banMember(
		...
		getMetricsService().counter({
			name: 'noctis.guild_bans.created',
			dimensions: {
				guild_id: params.guildId.toString(),
	...
	async unbanMember(
		...
		getMetricsService().counter({
			name: 'noctis.guild_bans.deleted',
			dimensions: {
				guild_id: params.guildId.toString(),
	...
	async listGuildAuditLogs(params: {
		...
		getMetricsService().counter({
			name: 'noctis.audit_logs.queries',
			dimensions: {
