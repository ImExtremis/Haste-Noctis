...
import {createEmojiID, type EmojiID, type GuildID, type UserID} from '@noctis/api/src/BrandedTypes';
import {mapGuildEmojisWithUsersToResponse, mapGuildEmojiToResponse} from '@noctis/api/src/guild/GuildModel';
import type {IGuildRepositoryAggregate} from '@noctis/api/src/guild/repositories/IGuildRepositoryAggregate';
import type {ContentHelpers} from '@noctis/api/src/guild/services/content/ContentHelpers';
...
import {MaxGuildEmojisAnimatedError} from '@noctis/errors/src/domains/guild/MaxGuildEmojisAnimatedError';
import {MaxGuildEmojisStaticError} from '@noctis/errors/src/domains/guild/MaxGuildEmojisStaticError';
...
import type {GuildEmojiResponse, GuildEmojiWithUserResponse} from '@noctis/schema/src/domains/guild/GuildEmojiSchemas';
