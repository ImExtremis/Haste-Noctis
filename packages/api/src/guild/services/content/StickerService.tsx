...
import {createStickerID, type GuildID, type StickerID, type UserID} from '@noctis/api/src/BrandedTypes';
import {mapGuildStickersWithUsersToResponse, mapGuildStickerToResponse} from '@noctis/api/src/guild/GuildModel';
...
import {MaxGuildStickersStaticError} from '@noctis/errors/src/domains/guild/MaxGuildStickersStaticError';
