...
import type {GuildDiscoveryByStatusRow, GuildDiscoveryRow} from '@noctis/api/src/database/types/GuildDiscoveryTypes';
import {GuildDiscovery, GuildDiscoveryByStatus} from '@noctis/api/src/Tables';
