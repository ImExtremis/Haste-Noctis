...
import type {EmojiID, GuildID, StickerID} from '@noctis/api/src/BrandedTypes';
import {
	BatchBuilder,
	buildPatchFromData,
...
import {IGuildContentRepository} from '@noctis/api/src/guild/repositories/IGuildContentRepository';
import {GuildEmoji} from '@noctis/api/src/models/GuildEmoji';
import {GuildSticker} from '@noctis/api/src/models/GuildSticker';
import {GuildEmojis, GuildEmojisByEmojiId, GuildStickers, GuildStickersByStickerId} from '@noctis/api/src/Tables';
