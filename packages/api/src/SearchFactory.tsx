...
import {ElasticsearchSearchProvider} from '@noctis/api/src/infrastructure/ElasticsearchSearchProvider';
...
import {getInjectedSearchProvider} from '@noctis/api/src/middleware/ServiceRegistry';
