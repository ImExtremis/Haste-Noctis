...
import {createEmojiID, createGuildID, createStickerID} from '@noctis/api/src/BrandedTypes';
import {
...
import type {ExpressionAssetPurger} from '@noctis/api/src/guild/services/content/ExpressionAssetPurger';
...
import {ExpressionPack} from '@noctis/api/src/models/ExpressionPack';
...
} from '@noctis/api/src/pack/PackExpressionAccessResolver';
import {mapPackToSummary} from '@noctis/api/src/pack/PackModel';
import type {PackRepository, PackType} from '@noctis/api/src/pack/PackRepository';
...
} from '@noctis/constants/src/LimitConstants';
import {UserFlags} from '@noctis/constants/src/UserConstants';
import {FeatureAccessError} from '@noctis/errors/src/domains/core/FeatureAccessError';
import {FeatureTemporarilyDisabledError} from '@noctis/errors/src/domains/core/FeatureTemporarilyDisabledError';
import {UnknownGuildEmojiError} from '@noctis/errors/src/domains/guild/UnknownGuildEmojiError';
import {UnknownGuildStickerError} from '@noctis/errors/src/domains/guild/UnknownGuildStickerError';
import {InvalidPackTypeError} from '@noctis/errors/src/domains/pack/InvalidPackTypeError';
import {MaxPackExpressionsError} from '@noctis/errors/src/domains/pack/MaxPackExpressionsError';
import {MaxPackLimitError} from '@noctis/errors/src/domains/pack/MaxPackLimitError';
import {PackAccessDeniedError} from '@noctis/errors/src/domains/pack/PackAccessDeniedError';
...
import type {PackDashboardResponse, PackDashboardSectionResponse} from '@noctis/schema/src/domains/pack/PackSchemas';
...
export class PackService {
	...
	async createPackSticker(params: {
		...
		getMetricsService().counter({name: 'noctis.stickers.created', value: 1});
		return response;
	}
	...
	async deletePackSticker(params: {
		...
		getMetricsService().counter({name: 'noctis.stickers.deleted', value: 1});
	}
