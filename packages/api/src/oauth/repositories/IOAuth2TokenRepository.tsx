...
import type {OAuth2AccessToken} from '@noctis/api/src/models/OAuth2AccessToken';
import type {OAuth2AuthorizationCode} from '@noctis/api/src/models/OAuth2AuthorizationCode';
import type {OAuth2RefreshToken} from '@noctis/api/src/models/OAuth2RefreshToken';
