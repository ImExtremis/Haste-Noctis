...
import {BatchBuilder, deleteOneOrMany, fetchMany, fetchOne, upsertOne} from '@noctis/api/src/database/Cassandra';
import type {
...
import {OAuth2AccessToken} from '@noctis/api/src/models/OAuth2AccessToken';
import {OAuth2AuthorizationCode} from '@noctis/api/src/models/OAuth2AuthorizationCode';
import {OAuth2RefreshToken} from '@noctis/api/src/models/OAuth2RefreshToken';
