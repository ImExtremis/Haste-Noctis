...
import {createApplicationID, type UserID} from '@noctis/api/src/BrandedTypes';
import {UsernameNotAvailableError} from '@noctis/api/src/infrastructure/DiscriminatorService';
...
import {mapApplicationToResponse, mapBotProfileToResponse} from '@noctis/api/src/oauth/OAuth2Mappers';
