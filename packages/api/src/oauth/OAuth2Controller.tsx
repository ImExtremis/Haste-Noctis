...
import {requireOAuth2BearerToken, requireOAuth2Scope} from '@noctis/api/src/middleware/OAuth2ScopeMiddleware';
...
import {HttpGetAuthorizeNotSupportedError} from '@noctis/errors/src/domains/auth/HttpGetAuthorizeNotSupportedError';
