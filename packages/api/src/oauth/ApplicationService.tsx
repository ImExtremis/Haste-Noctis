...
import {applicationIdToUserId} from '@noctis/api/src/BrandedTypes';
...
import type {UserRow} from '@noctis/api/src/database/types/UserTypes';
import type {DiscriminatorService} from '@noctis/api/src/infrastructure/DiscriminatorService';
...
import {remapAuthorMessagesToDeletedUser} from '@noctis/api/src/oauth/ApplicationMessageAuthorAnonymization';
...
import {DELETED_USER_GLOBAL_NAME, DELETED_USER_USERNAME, UserFlags} from '@noctis/constants/src/UserConstants';
import {ValidationErrorCodes} from '@noctis/constants/src/ValidationErrorCodes';
import {ForbiddenError} from '@noctis/errors/src/domains/core/ForbiddenError';
...
import {UnclaimedAccountCannotCreateApplicationsError} from '@noctis/errors/src/domains/oauth/UnclaimedAccountCannotCreateApplicationsError';
