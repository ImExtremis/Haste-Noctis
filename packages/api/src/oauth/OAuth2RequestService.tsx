...
import type {SudoVerificationBody} from '@noctis/api/src/auth/services/SudoVerificationService';
import {requireSudoMode} from '@noctis/api/src/auth/services/SudoVerificationService';
import {createApplicationID, createGuildID, createRoleID, type UserID} from '@noctis/api/src/BrandedTypes';
...
import {ApplicationNotOwnedError} from '@noctis/api/src/oauth/ApplicationService';
...
} from '@noctis/api/src/oauth/OAuth2Mappers';
import {ACCESS_TOKEN_TTL_SECONDS, type OAuth2Service} from '@noctis/api/src/oauth/OAuth2Service';
...
import {parseClientCredentials} from '@noctis/api/src/oauth/utils/ParseClientCredentials';
import type {IUserRepository} from '@noctis/api/src/user/IUserRepository';
import {mapUserToOAuthResponse} from '@noctis/api/src/user/UserMappers';
import {verifyPassword} from '@noctis/api/src/utils/PasswordUtils';
import {ALL_PERMISSIONS, Permissions} from '@noctis/constants/src/ChannelConstants';
import {JoinSourceTypes} from '@noctis/constants/src/GuildConstants';
import {AccessDeniedError} from '@noctis/errors/src/domains/core/AccessDeniedError';
import {InvalidPermissionsIntegerError} from '@noctis/errors/src/domains/core/InvalidPermissionsIntegerError';
import {InvalidPermissionsNegativeError} from '@noctis/errors/src/domains/core/InvalidPermissionsNegativeError';
...
import {BotAlreadyInGuildError} from '@noctis/errors/src/domains/oauth/BotAlreadyInGuildError';
import {BotUserNotFoundError} from '@noctis/errors/src/domains/oauth/BotUserNotFoundError';
import {InvalidClientError} from '@noctis/errors/src/domains/oauth/InvalidClientError';
import {InvalidGrantError} from '@noctis/errors/src/domains/oauth/InvalidGrantError';
import {InvalidResponseTypeForNonBotError} from '@noctis/errors/src/domains/oauth/InvalidResponseTypeForNonBotError';
import {MissingClientSecretError} from '@noctis/errors/src/domains/oauth/MissingClientSecretError';
import {NotABotApplicationError} from '@noctis/errors/src/domains/oauth/NotABotApplicationError';
import {RedirectUriRequiredForNonBotError} from '@noctis/errors/src/domains/oauth/RedirectUriRequiredForNonBotError';
import {UnknownApplicationError} from '@noctis/errors/src/domains/oauth/UnknownApplicationError';
import type {
	...
	RevokeRequestForm,
	TokenRequest,
} from '@noctis/schema/src/domains/oauth/OAuthSchemas';
