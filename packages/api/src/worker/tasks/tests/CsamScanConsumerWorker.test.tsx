...
import type {CsamScanQueueEntry, CsamScanResultMessage} from '@noctis/api/src/csam/CsamTypes';
...
} from '@noctis/api/src/test/msw/handlers/PhotoDnaHandlers';
import {server} from '@noctis/api/src/test/msw/server';
import {clearWorkerDependencies, setWorkerDependenciesForTest} from '@noctis/api/src/worker/WorkerContext';
import {KVCacheProvider} from '@noctis/cache/src/providers/KVCacheProvider';
import type {WorkerTaskHandler, WorkerTaskHelpers} from '@noctis/worker/src/contracts/WorkerTask';
...
describe('CsamScanConsumerWorker', () => {
	...
	beforeEach(async () => {
		...
		const module = await import('@noctis/api/src/worker/tasks/CsamScanConsumerWorker');
