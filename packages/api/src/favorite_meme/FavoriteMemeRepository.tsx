...
import type {MemeID, UserID} from '@noctis/api/src/BrandedTypes';
import {BatchBuilder, fetchMany, fetchOne, upsertOne} from '@noctis/api/src/database/Cassandra';
import type {FavoriteMemeRow} from '@noctis/api/src/database/types/UserTypes';
import {
	type CreateFavoriteMemeParams,
	IFavoriteMemeRepository,
} from '@noctis/api/src/favorite_meme/IFavoriteMemeRepository';
import {FavoriteMeme} from '@noctis/api/src/models/FavoriteMeme';
import {FavoriteMemes, FavoriteMemesByMemeId} from '@noctis/api/src/Tables';
