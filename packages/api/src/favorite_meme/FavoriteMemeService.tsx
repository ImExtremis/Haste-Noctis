...
import type {ChannelID, MemeID, MessageID, UserID} from '@noctis/api/src/BrandedTypes';
import {createAttachmentID, createMemeID, userIdToChannelId} from '@noctis/api/src/BrandedTypes';
...
import {MAX_FAVORITE_MEME_TAGS, MAX_FAVORITE_MEMES_NON_PREMIUM} from '@noctis/constants/src/LimitConstants';
...
import {MaxFavoriteMemesError} from '@noctis/errors/src/domains/core/MaxFavoriteMemesError';
import {MediaMetadataError} from '@noctis/errors/src/domains/core/MediaMetadataError';
import {UnknownFavoriteMemeError} from '@noctis/errors/src/domains/core/UnknownFavoriteMemeError';
import {normalizeFilename} from '@noctis/schema/src/primitives/FileValidators';
