...
import type {TenorCategoryTagResponse, TenorGifResponse} from '@noctis/schema/src/domains/tenor/TenorSchemas';
import {ms} from 'itty-time';

const TENOR_BASE_URL = 'https://tenor.googleapis.com/v2';
const DEFAULT_MEDIA_FILTER = 'webm,mp4';
const DEFAULT_CONTENT_FILTER = 'low';
const CLIENT_KEY = 'noctis';
const MAX_RETRIES = 3;
		...
		for (let attempt = 0; attempt < MAX_RETRIES; attempt++) {
			try {
				const response = await fetch(url.toString(), {
					headers: {'User-Agent': NOCTIS_USER_AGENT},
