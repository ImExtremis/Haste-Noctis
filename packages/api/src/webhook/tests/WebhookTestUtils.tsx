...
import {createMultipartFormData} from '@noctis/api/src/channel/tests/AttachmentTestUtils';
import {getPngDataUrl, VALID_PNG_BASE64} from '@noctis/api/src/emoji/tests/EmojiTestUtils';
...
import type {GuildEmojiWithUserResponse} from '@noctis/schema/src/domains/guild/GuildEmojiSchemas';
