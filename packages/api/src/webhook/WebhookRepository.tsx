...
import {createWebhookID} from '@noctis/api/src/BrandedTypes';
import {
	BatchBuilder,
	buildPatchFromData,
	deleteOneOrMany,
...
import type {WebhookRow} from '@noctis/api/src/database/types/ChannelTypes';
import {WEBHOOK_COLUMNS} from '@noctis/api/src/database/types/ChannelTypes';
import {Webhook} from '@noctis/api/src/models/Webhook';
import {Webhooks, WebhooksByChannel, WebhooksByGuild} from '@noctis/api/src/Tables';
import {IWebhookRepository} from '@noctis/api/src/webhook/IWebhookRepository';
