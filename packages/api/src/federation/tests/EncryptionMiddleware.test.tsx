...
import {
	...
	isEncryptedRequest,
} from '@noctis/api/src/federation/EncryptionMiddleware';
import {initializeKeyManager, KeyManager, resetKeyManager} from '@noctis/api/src/federation/KeyManager';
...
const TEST_KEY_DIR = '/tmp/noctis-encryption-middleware-test-keys';
