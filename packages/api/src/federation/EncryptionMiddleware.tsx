...
import {getKeyManager, KeyManagerError} from '@noctis/api/src/federation/KeyManager';
import type {HonoEnv} from '@noctis/api/src/types/HonoEnv';
import {DecryptionFailedError} from '@noctis/errors/src/domains/federation/DecryptionFailedError';
import {EmptyEncryptedBodyError} from '@noctis/errors/src/domains/federation/EmptyEncryptedBodyError';
import {EncryptionFailedError} from '@noctis/errors/src/domains/federation/EncryptionFailedError';
import {InvalidDecryptedJsonError} from '@noctis/errors/src/domains/federation/InvalidDecryptedJsonError';
import {InvalidEphemeralKeyError} from '@noctis/errors/src/domains/federation/InvalidEphemeralKeyError';
import {InvalidIvError} from '@noctis/errors/src/domains/federation/InvalidIvError';
import {MissingEphemeralKeyError} from '@noctis/errors/src/domains/federation/MissingEphemeralKeyError';
import {MissingIvError} from '@noctis/errors/src/domains/federation/MissingIvError';
import {createMiddleware} from 'hono/factory';

const ENCRYPTED_CONTENT_TYPE = 'application/x-noctis-encrypted';
const EPHEMERAL_KEY_HEADER = 'x-noctis-ephemeral-key';
const IV_HEADER = 'x-noctis-iv';
const ENCRYPTED_RESPONSE_HEADER = 'x-noctis-encrypted-response';
