...
import type {MeilisearchAuditLogAdapterOptions} from '@noctis/meilisearch_search/src/adapters/MeilisearchAuditLogAdapter';
import {MeilisearchAuditLogAdapter} from '@noctis/meilisearch_search/src/adapters/MeilisearchAuditLogAdapter';
