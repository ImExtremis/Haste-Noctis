...
import {convertToSearchableGuildMember} from '@noctis/api/src/search/guild_member/GuildMemberSearchSerializer';
...
import type {MeilisearchGuildMemberAdapterOptions} from '@noctis/meilisearch_search/src/adapters/MeilisearchGuildMemberAdapter';
import {MeilisearchGuildMemberAdapter} from '@noctis/meilisearch_search/src/adapters/MeilisearchGuildMemberAdapter';
...
} from '@noctis/schema/src/contracts/search/SearchDocumentTypes';
