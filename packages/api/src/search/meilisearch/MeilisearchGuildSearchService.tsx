...
import type {MeilisearchGuildAdapterOptions} from '@noctis/meilisearch_search/src/adapters/MeilisearchGuildAdapter';
import {MeilisearchGuildAdapter} from '@noctis/meilisearch_search/src/adapters/MeilisearchGuildAdapter';
...
export interface MeilisearchGuildSearchServiceOptions extends MeilisearchGuildAdapterOptions {}

export class MeilisearchGuildSearchService
	extends MeilisearchSearchServiceBase<GuildSearchFilters, SearchableGuild, MeilisearchGuildAdapter>
	implements IGuildSearchService
{
	constructor(options: MeilisearchGuildSearchServiceOptions) {
		super(new MeilisearchGuildAdapter(options));
	}
