...
import {convertToSearchableUser} from '@noctis/api/src/search/user/UserSearchSerializer';
import type {MeilisearchUserAdapterOptions} from '@noctis/meilisearch_search/src/adapters/MeilisearchUserAdapter';
import {MeilisearchUserAdapter} from '@noctis/meilisearch_search/src/adapters/MeilisearchUserAdapter';
