...
import type {
	...
	ScanBase64Params,
	ScanMediaParams,
} from '@noctis/api/src/csam/providers/ICsamScanProvider';
...
} from '@noctis/api/src/telemetry/CsamTelemetry';
...
export class ArachnidShieldProvider implements ICsamScanProvider {
	...
	async scanMedia(params: ScanMediaParams): Promise<CsamScanResult> {
		...
		return this.withSpan('noctis.csam.scan_media', 'noctis.csam.scans.media', context, async () => {
	...
	async scanBase64(params: ScanBase64Params): Promise<CsamScanResult> {
		...
		return this.withSpan('noctis.csam.scan_base64', 'noctis.csam.scans.base64', context, async () => {
			const start = Date.now();
