...
import type {CsamResourceType, PhotoDnaMatchResult} from '@noctis/api/src/csam/CsamTypes';
import type {ICsamEvidenceService} from '@noctis/api/src/csam/ICsamEvidenceService';
...
import type {IReportRepository} from '@noctis/api/src/report/IReportRepository';
