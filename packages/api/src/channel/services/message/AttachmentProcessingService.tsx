...
import {createAttachmentID} from '@noctis/api/src/BrandedTypes';
...
import type {ICsamReportSnapshotService} from '@noctis/api/src/csam/ICsamReportSnapshotService';
import type {ISynchronousCsamScanner} from '@noctis/api/src/csam/ISynchronousCsamScanner';
import type {SynchronousCsamScanResult} from '@noctis/api/src/csam/SynchronousCsamScanner';
...
import {recordAttachmentOperation} from '@noctis/api/src/telemetry/MessageTelemetry';
import {MessageAttachmentFlags} from '@noctis/constants/src/ChannelConstants';
