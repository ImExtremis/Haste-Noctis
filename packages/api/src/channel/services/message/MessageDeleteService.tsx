...
import {createMessageID, createUserID} from '@noctis/api/src/BrandedTypes';
...
import {isOperationDisabled, purgeMessageAttachments} from '@noctis/api/src/channel/services/message/MessageHelpers';
...
import {createSnowflakeFromTimestamp} from '@noctis/snowflake/src/Snowflake';
...
export class MessageDeleteService {
	...
	async bulkDeleteMessages({
		...
		return await withBusinessSpan(
			'noctis.message.bulk_delete',
			'noctis.messages.bulk_deleted',
			{
