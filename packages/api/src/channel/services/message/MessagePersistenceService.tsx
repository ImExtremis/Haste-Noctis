...
import {createAttachmentID, createGuildID} from '@noctis/api/src/BrandedTypes';
import type {AttachmentToProcess} from '@noctis/api/src/channel/AttachmentDTOs';
...
import {AttachmentProcessingService} from '@noctis/api/src/channel/services/message/AttachmentProcessingService';
import {MessageContentService} from '@noctis/api/src/channel/services/message/MessageContentService';
import {MessageEmbedAttachmentResolver} from '@noctis/api/src/channel/services/message/MessageEmbedAttachmentResolver';
import {VIRUS_MESSAGE_PREFIX, VIRUS_RECIPE_SUGGESTIONS} from '@noctis/api/src/channel/services/message/MessageHelpers';
import {MessageStickerService} from '@noctis/api/src/channel/services/message/MessageStickerService';
import type {
	MessageAttachment,
	MessageEmbed,
	MessageReference,
...
import type {ISnowflakeService} from '@noctis/api/src/infrastructure/ISnowflakeService';
...
import type {MessageSnapshot} from '@noctis/api/src/models/MessageSnapshot';
...
import {MessageFlags, Permissions, SENDABLE_MESSAGE_FLAGS} from '@noctis/constants/src/ChannelConstants';
