...
import type {AttachmentID, ChannelID, UserID} from '@noctis/api/src/BrandedTypes';
import {createAttachmentID, userIdToChannelId} from '@noctis/api/src/BrandedTypes';
...
import {Attachment} from '@noctis/api/src/models/Attachment';
import type {Message} from '@noctis/api/src/models/Message';
import {MessageSnapshot as MessageSnapshotModel} from '@noctis/api/src/models/MessageSnapshot';
