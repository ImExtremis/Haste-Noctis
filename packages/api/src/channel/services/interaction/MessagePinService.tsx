...
import type {MessageID, UserID} from '@noctis/api/src/BrandedTypes';
...
import {MessageTypes, Permissions} from '@noctis/constants/src/ChannelConstants';
...
export class MessagePinService extends MessageInteractionBase {
	...
	async unpinMessage({
		...
		return await withBusinessSpan(
			'noctis.message.unpin',
			'noctis.messages.unpinned',
			{
				channel_id: authChannel.channel.id.toString(),
				message_id: messageId.toString(),
				channel_type: authChannel.channel.type.toString(),
