...
import {type ChannelID, createChannelID, type UserID} from '@noctis/api/src/BrandedTypes';
...
import {EmptyStreamThumbnailPayloadError} from '@noctis/errors/src/domains/channel/EmptyStreamThumbnailPayloadError';
import {InvalidStreamKeyFormatError} from '@noctis/errors/src/domains/channel/InvalidStreamKeyFormatError';
import {InvalidStreamThumbnailPayloadError} from '@noctis/errors/src/domains/channel/InvalidStreamThumbnailPayloadError';
import {StreamKeyChannelMismatchError} from '@noctis/errors/src/domains/channel/StreamKeyChannelMismatchError';
import {MissingPermissionsError} from '@noctis/errors/src/domains/core/MissingPermissionsError';
import {StreamKeyScopeMismatchError} from '@noctis/errors/src/domains/oauth/StreamKeyScopeMismatchError';
...
export class StreamService {
	...
	async getPreview(params: {
		...
		if (preview) {
			getMetricsService().counter({name: 'noctis.stream.preview.fetched', value: 1});
		}
		return preview;
	}
	...
	async uploadPreview(params: {
		...
		getMetricsService().counter({name: 'noctis.stream.preview.uploaded', value: 1});
	}
}
