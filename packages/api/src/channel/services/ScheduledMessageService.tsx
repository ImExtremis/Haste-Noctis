...
import type {ScheduledMessagePayload} from '@noctis/api/src/models/ScheduledMessage';
import {ScheduledMessage} from '@noctis/api/src/models/ScheduledMessage';
import type {User} from '@noctis/api/src/models/User';
import {withBusinessSpan} from '@noctis/api/src/telemetry/BusinessSpans';
import type {ScheduledMessageRepository} from '@noctis/api/src/user/repositories/ScheduledMessageRepository';
...
export class ScheduledMessageService {
	...
	async createScheduledMessage(params: ScheduleParams): Promise<ScheduledMessage> {
		return await withBusinessSpan(
			'noctis.message.schedule',
			'noctis.messages.scheduled',
			{
	...
	async updateScheduledMessage(params: UpdateScheduleParams): Promise<ScheduledMessage> {
		return await withBusinessSpan(
			'noctis.message.schedule.update',
			'noctis.messages.scheduled_updated',
			{
				channel_id: params.channelId.toString(),
	...
	async cancelScheduledMessage(userId: UserID, scheduledMessageId: MessageID): Promise<void> {
		...
		recordCounter({
			name: 'noctis.messages.scheduled_deleted',
