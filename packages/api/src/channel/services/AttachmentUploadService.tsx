...
import type {UploadedAttachment} from '@noctis/api/src/channel/AttachmentDTOs';
...
import {recordAttachmentOperation, recordAttachmentUploadDuration} from '@noctis/api/src/telemetry/MessageTelemetry';
...
import {ATTACHMENT_MAX_SIZE_NON_PREMIUM} from '@noctis/constants/src/LimitConstants';
...
export class AttachmentUploadService {
	...
	async deleteAttachment({
		...
		return await withBusinessSpan(
			'noctis.attachment.delete',
			'noctis.attachments.deleted',
			{
