...
import {IChannelDataRepository} from '@noctis/api/src/channel/repositories/IChannelDataRepository';
import {
	BatchBuilder,
	buildPatchFromData,
	Db,
...
import {CHANNEL_COLUMNS} from '@noctis/api/src/database/types/ChannelTypes';
import {Logger} from '@noctis/api/src/Logger';
import {Channel} from '@noctis/api/src/models/Channel';
import {Channels, ChannelsByGuild} from '@noctis/api/src/Tables';
