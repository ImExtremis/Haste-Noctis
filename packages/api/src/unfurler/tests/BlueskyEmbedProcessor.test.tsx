...
import type {BlueskyApiClient} from '@noctis/api/src/unfurler/resolvers/bluesky/BlueskyApiClient';
...
import type {BlueskyPost, Facet} from '@noctis/api/src/unfurler/resolvers/bluesky/BlueskyTypes';
import {MockMediaService} from '@noctis/api/src/unfurler/tests/ResolverTestUtils';
...
describe('BlueskyEmbedProcessor', () => {
	...
	describe('BlueskyResolver.formatCount', () => {
		let BlueskyResolver: typeof import('@noctis/api/src/unfurler/resolvers/BlueskyResolver').BlueskyResolver;

		beforeEach(async () => {
			const module = await import('@noctis/api/src/unfurler/resolvers/BlueskyResolver');
