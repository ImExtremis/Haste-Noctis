...
import type {AttachmentID, ChannelID, GuildID, MemeID, UserID} from '@noctis/api/src/BrandedTypes';
...
import {
	...
	type BannedIpRow,
	type BannedPhoneRow,
} from '@noctis/api/src/database/types/AdminArchiveTypes';
import {
	ADMIN_API_KEY_BY_CREATOR_COLUMNS,
	ADMIN_API_KEY_COLUMNS,
	type AdminApiKeyByCreatorRow,
	type AdminApiKeyRow,
} from '@noctis/api/src/database/types/AdminAuthTypes';
import {
...
import {
	...
	WEBHOOK_COLUMNS,
	type WebhookRow,
} from '@noctis/api/src/database/types/ChannelTypes';
import {USER_CONNECTION_COLUMNS, type UserConnectionRow} from '@noctis/api/src/database/types/ConnectionTypes';
import {
...
} from '@noctis/api/src/database/types/GuildTypes';
import {
	INSTANCE_CONFIGURATION_COLUMNS,
	type InstanceConfigurationRow,
} from '@noctis/api/src/database/types/InstanceConfigTypes';
import {
...
} from '@noctis/api/src/database/types/OAuth2Types';
import {
...
} from '@noctis/api/src/database/types/PaymentTypes';
import {
...
} from '@noctis/api/src/database/types/ReportTypes';
import {SYSTEM_DM_JOB_COLUMNS, type SystemDmJobRow} from '@noctis/api/src/database/types/SystemDmJobTypes';
import {
...
import {
	USER_DEVICE_COLUMNS,
	type UserDeviceRow,
} from '@noctis/api/src/database/types/UserDeviceTypes';
import {ATTACHMENT_DECAY_COLUMNS, type AttachmentDecayRow} from '@noctis/api/src/types/AttachmentDecayTypes';
...
export const UserDevices = defineTable<UserDeviceRow, 'user_id' | 'device_hash'>({
	name: 'user_devices',
	columns: USER_DEVICE_COLUMNS,
	primaryKey: ['user_id', 'device_hash'],
});
