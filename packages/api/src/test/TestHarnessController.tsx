...
import type {IpAuthorizationTicketCache} from '@noctis/api/src/auth/services/AuthLoginService';
import {
	createApplicationID,
	createAttachmentID,
	createChannelID,
	...
	type MessageID,
	type UserID,
} from '@noctis/api/src/BrandedTypes';
...
import {BatchBuilder, defineTable, deleteOneOrMany, fetchMany, fetchOne} from '@noctis/api/src/database/Cassandra';
...
import {
	...
	type MessageRow,
} from '@noctis/api/src/database/types/MessageTypes';
...
import {StorageService} from '@noctis/api/src/infrastructure/StorageService';
import {Logger} from '@noctis/api/src/Logger';
import {requireOAuth2Scope} from '@noctis/api/src/middleware/OAuth2ScopeMiddleware';
import {getKVClient} from '@noctis/api/src/middleware/ServiceRegistry';
import {OAuth2TokenRepository} from '@noctis/api/src/oauth/repositories/OAuth2TokenRepository';
import {IpAuthorizationTokens, OAuth2AccessTokensByUser} from '@noctis/api/src/Tables';
import {resetTestHarnessState} from '@noctis/api/src/test/TestHarnessReset';
import type {HonoApp, HonoEnv} from '@noctis/api/src/types/HonoEnv';
import {AuthSessionRepository} from '@noctis/api/src/user/repositories/auth/AuthSessionRepository';
import {ScheduledMessageRepository} from '@noctis/api/src/user/repositories/ScheduledMessageRepository';
import {UserChannelRepository} from '@noctis/api/src/user/repositories/UserChannelRepository';
...
import {ScheduledMessageExecutor} from '@noctis/api/src/worker/executors/ScheduledMessageExecutor';
import {processExpiredAttachments} from '@noctis/api/src/worker/tasks/ExpireAttachments';
import {processInactivityDeletionsCore} from '@noctis/api/src/worker/tasks/ProcessInactivityDeletions';
import {setWorkerDependencies} from '@noctis/api/src/worker/WorkerContext';
import {initializeWorkerDependencies} from '@noctis/api/src/worker/WorkerDependencies';
import {ChannelTypes} from '@noctis/constants/src/ChannelConstants';
import {MAX_GUILD_MEMBERS_VERY_LARGE_GUILD} from '@noctis/constants/src/LimitConstants';
import {SuspiciousActivityFlags, UserFlags} from '@noctis/constants/src/UserConstants';
...
import type {ITestEmailService, SentEmailRecord} from '@noctis/email/src/ITestEmailService';
import {EmailServiceNotTestableError} from '@noctis/errors/src/domains/auth/EmailServiceNotTestableError';
import {UnknownMessageError} from '@noctis/errors/src/domains/channel/UnknownMessageError';
import {AclsMustBeNonEmptyError} from '@noctis/errors/src/domains/core/AclsMustBeNonEmptyError';
import {DeletionFailedError} from '@noctis/errors/src/domains/core/DeletionFailedError';
import {InputValidationError} from '@noctis/errors/src/domains/core/InputValidationError';
import {InvalidAclsFormatError} from '@noctis/errors/src/domains/core/InvalidAclsFormatError';
import {InvalidFlagsFormatError} from '@noctis/errors/src/domains/core/InvalidFlagsFormatError';
import {InvalidSuspiciousFlagsFormatError} from '@noctis/errors/src/domains/core/InvalidSuspiciousFlagsFormatError';
import {InvalidSystemFlagError} from '@noctis/errors/src/domains/core/InvalidSystemFlagError';
import {InvalidTimestampError} from '@noctis/errors/src/domains/core/InvalidTimestampError';
import {NoPendingDeletionError} from '@noctis/errors/src/domains/core/NoPendingDeletionError';
import {ProcessingFailedError} from '@noctis/errors/src/domains/core/ProcessingFailedError';
import {TestHarnessDisabledError} from '@noctis/errors/src/domains/core/TestHarnessDisabledError';
import {TestHarnessForbiddenError} from '@noctis/errors/src/domains/core/TestHarnessForbiddenError';
import {UnknownSuspiciousFlagError} from '@noctis/errors/src/domains/core/UnknownSuspiciousFlagError';
import {UpdateFailedError} from '@noctis/errors/src/domains/core/UpdateFailedError';
import {UnknownGuildError} from '@noctis/errors/src/domains/guild/UnknownGuildError';
import {UnknownGuildMemberError} from '@noctis/errors/src/domains/guild/UnknownGuildMemberError';
import {UnknownHarvestError} from '@noctis/errors/src/domains/moderation/UnknownHarvestError';
import {InvalidBotFlagError} from '@noctis/errors/src/domains/oauth/InvalidBotFlagError';
import {UnknownUserError} from '@noctis/errors/src/domains/user/UnknownUserError';
import {UnknownUserFlagError} from '@noctis/errors/src/domains/user/UnknownUserFlagError';
import {RpcRequest} from '@noctis/schema/src/domains/rpc/RpcSchemas';
import {createSnowflakeFromTimestamp, snowflakeToDate} from '@noctis/snowflake/src/Snowflake';
import * as BucketUtils from '@noctis/snowflake/src/SnowflakeBuckets';
...
export function TestHarnessController(app: HonoApp) {
	...
	app.post('/test/channels/:channelId/mark-indexed', async (ctx) => {
		...
		const {getMessageSearchService} = await import('@noctis/api/src/SearchFactory');
	...
	app.post('/test/guilds/:guildId/mark-members-indexed', async (ctx) => {
		...
		const {getGuildMemberSearchService} = await import('@noctis/api/src/SearchFactory');
