...
import {type ChannelID, type GuildID, guildIdToRoleId, type RoleID, type UserID} from '@noctis/api/src/BrandedTypes';
...
export class NoopGatewayService extends IGatewayService {
	...
	async getUserPermissions(params: {guildId: GuildID; userId: UserID; channelId?: ChannelID}): Promise<bigint> {
		...
		const {ChannelDataRepository} = await import('@noctis/api/src/channel/repositories/ChannelDataRepository');
