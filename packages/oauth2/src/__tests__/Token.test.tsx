...
import type {OAuth2Config} from '@noctis/oauth2/src/OAuth2';
import {exchangeCode, type LoggerInterface, revokeToken, type TokenResponse} from '@noctis/oauth2/src/Token';
