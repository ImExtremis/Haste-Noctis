...
import type {LabelProps, TextProps} from '@noctis/ui/src/types/Common';
import {type ColorIntensity, type ColorTone, getColorClasses} from '@noctis/ui/src/utils/ColorVariants';
