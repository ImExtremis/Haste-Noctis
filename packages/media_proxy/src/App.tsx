...
import {createErrorHandler} from '@noctis/errors/src/ErrorHandler';
...
import {createAttachmentsHandler} from '@noctis/media_proxy/src/controllers/AttachmentsController';
import {createExternalMediaHandler} from '@noctis/media_proxy/src/controllers/ExternalMediaController';
import {createFrameExtractionHandler} from '@noctis/media_proxy/src/controllers/FrameExtractionController';
import {
	createGuildMemberImageRouteHandler,
	createImageRouteHandler,
	createSimpleImageRouteHandler,
} from '@noctis/media_proxy/src/controllers/ImageController';
import {createMetadataHandler} from '@noctis/media_proxy/src/controllers/MetadataController';
import {createStaticProxyHandler} from '@noctis/media_proxy/src/controllers/StaticProxyController';
import {createStickerRouteHandler} from '@noctis/media_proxy/src/controllers/StickerController';
import {createThemeHandler} from '@noctis/media_proxy/src/controllers/ThemeController';
import {createThumbnailHandler} from '@noctis/media_proxy/src/controllers/ThumbnailController';
import {CloudflareEdgeIPService} from '@noctis/media_proxy/src/lib/CloudflareEdgeIPService';
import {createCodecValidator} from '@noctis/media_proxy/src/lib/CodecValidation';
import {createFFmpegUtils, createFrameExtractor} from '@noctis/media_proxy/src/lib/FFmpegUtils';
import {createImageProcessor} from '@noctis/media_proxy/src/lib/ImageProcessing';
import {InMemoryCoalescer} from '@noctis/media_proxy/src/lib/InMemoryCoalescer';
import {createMediaTransformService} from '@noctis/media_proxy/src/lib/MediaTransformService';
import {createMediaValidator} from '@noctis/media_proxy/src/lib/MediaValidation';
import {createMimeTypeUtils} from '@noctis/media_proxy/src/lib/MimeTypeUtils';
import {NSFWDetectionService} from '@noctis/media_proxy/src/lib/NSFWDetectionService';
import {createS3Client, createS3Utils} from '@noctis/media_proxy/src/lib/S3Utils';
import {createInternalNetworkRequired} from '@noctis/media_proxy/src/middleware/AuthMiddleware';
import {createCloudflareFirewall} from '@noctis/media_proxy/src/middleware/CloudflareFirewall';
import {createMetricsMiddleware} from '@noctis/media_proxy/src/middleware/MetricsMiddleware';
import {createFrameService} from '@noctis/media_proxy/src/services/FrameService';
import {createMetadataService} from '@noctis/media_proxy/src/services/MetadataService';
import type {HonoEnv} from '@noctis/media_proxy/src/types/HonoEnv';
import type {MediaProxyConfig} from '@noctis/media_proxy/src/types/MediaProxyConfig';
import type {MediaProxyServices} from '@noctis/media_proxy/src/types/MediaProxyServices';
import type {MetricsInterface} from '@noctis/media_proxy/src/types/Metrics';
import type {TracingInterface} from '@noctis/media_proxy/src/types/Tracing';
import {createHttpClient} from '@noctis/media_proxy/src/utils/FetchUtils';
import type {RateLimitService} from '@noctis/rate_limit/src/RateLimitService';
import {captureException} from '@noctis/sentry/src/Sentry';
import {Hono} from 'hono';
import {HTTPException} from 'hono/http-exception';
import * as v from 'valibot';

const NOCTIS_USER_AGENT = 'Mozilla/5.0 (compatible; Noctisbot/1.0; +https://noctis.app)';
...
export async function createMediaProxyApp(options: CreateMediaProxyAppOptions): Promise<MediaProxyAppResult> {
	...
	const httpClient = createHttpClient(NOCTIS_USER_AGENT, {metrics, tracing});
