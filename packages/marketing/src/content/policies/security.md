If you believe you have found a security vulnerability in Noctis, please report it responsibly. This policy explains what is in scope, how to submit a report, what we need from you, and what you can expect from us.

## Safe harbor

If you follow this policy, act in good faith, and avoid privacy violations or service disruption, Noctis will not pursue legal action against you for your security research.

## Who should read this

Security researchers, community members, and anyone who discovers a potential security issue in Noctis should read this policy before sending a report. It explains what is in scope, how we triage findings, and how we acknowledge and reward responsible disclosures.

## Scope

### In scope

Noctis websites, applications, and services operated by Haste Industries, including the following domains and any subdomain of these domains:

- `noctis.gg`
- `noctis.gift`
- `noctisapp.com`
- `noctis.dev`
- `noctisusercontent.com`
- `static.noctis.app`
- `noctis.media`
- `noctis.app`
...
- Infrastructure, systems, and operational services directly managed by Noctis that impact authentication, authorization, payments, community data, or the processing of security- or privacy-relevant data (including user identifiers, account metadata, logs, analytics, telemetry, and similar signals).
...
- Self-hosted Noctis instances that declare trust in Noctis security guidance, provided:
...
- Social engineering, phishing, bribery, coercion, or attempts to manipulate Noctis staff or users.
...
- General UI bugs, feature requests, or non-security support issues (email support@noctis.app for those).
...
Email your report to security@noctis.app.
...
- A Bug Hunter badge on your Noctis profile.
- Stellar gift codes on noctis.app so you can access premium features.
...
- Please report findings privately to security@noctis.app.
...
Thank you for helping keep Noctis secure.
