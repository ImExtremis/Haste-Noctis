...
These terms of service ("Terms") constitute a legally binding contract between you and Haste Industries (Swedish organization number: 559537-3993). We are based in Stockholm County, Sweden, and we operate the Noctis chat platform and related services. Throughout these Terms, references to "Noctis", "we", "us" or "our" refer to Haste Industries and our Services.

By creating an account or using Noctis in any way, you agree to be bound by these Terms, our [Privacy Policy](/privacy), and our [Community Guidelines](/guidelines). If you do not agree to these Terms, you must not use Noctis.
...
- **"Services"** means the Noctis applications (web, mobile, desktop), HTTP and WebSocket APIs, related websites and domains, and any other products, software, features, or services provided by Noctis.
...
- **"Stellar"** means Noctis's optional paid subscription offering that provides enhanced features and benefits.
- **"Community"** means a server, space, or similar environment created or administered on Noctis where users can communicate or share content.
...
- **"Account"** means a user account registered with Noctis that is associated with a unique identifier and, typically, an email address.
- **"Privacy Policy"** means our [Privacy Policy](/privacy), which explains how we collect, use, and protect personal data.
- **"Community Guidelines"** means our [Community Guidelines](/guidelines), which govern acceptable behavior and content on Noctis.

Capitalized terms that are not defined in this section have the meaning given to them elsewhere in these Terms.

## 1. Eligibility and Accounts

### 1.1 Eligibility to Use Noctis
...
To use most features of Noctis, you must create an Account. You are solely responsible for:
...
You must promptly notify us at support@noctis.app if you become aware of any unauthorized access to or use of your Account.
...
These Terms govern your use of Noctis as a consumer and for general personal or community use.
...
Noctis is a communication and community platform where you can:
...
- subscribe to Stellar for access to premium features and benefits.
...
### 3.2 License to Noctis

To operate, secure, and improve the Services, you grant Noctis a limited license to your User Content.

Specifically, by submitting, uploading, or otherwise making User Content available on or through the Services, you grant Noctis a worldwide, non-exclusive, royalty-free, transferable, and sublicensable license to:
...
If you believe that content on Noctis infringes your copyrights, please notify us at dmca@noctis.app with the following information:
...
- use Noctis primarily as unlimited cloud storage rather than for communication or community activities;
...
- use Noctis infrastructure for command-and-control of malware, botnets, or other harmful systems; or
- deliberately attempt to stress test, overload, or degrade our infrastructure without our prior written permission.

We will not target normal users who are using Noctis in good faith for its intended purposes. This policy exists to prevent abuse that harms the platform and other users.
...
By providing a payment method to Noctis, you:
...
### 6.2 Noctis Stellar Subscription

We offer an optional premium subscription service called **Noctis Stellar** that provides enhanced features and benefits.

#### 6.2.1 Automatic Renewal

By subscribing to Stellar, you agree to recurring automatic payments. Unless you cancel, your subscription will automatically renew at the end of each billing period (for example, monthly or annually), and we will automatically charge your payment method at each renewal date for the applicable subscription fee and any applicable taxes.
...
If you already have an active, continuously renewing Stellar subscription:
...
If your subscription is canceled, expires, or lapses (for example, due to non-payment) and you later start a new Stellar subscription, the then-current price for new subscriptions will apply and will be shown to you before you confirm the new subscription.
...
#### 6.3.1 Stellar Subscription Refunds

You may request a refund within 14 days of purchasing a Stellar subscription by emailing support@noctis.app from your registered Account email address, unless applicable law grants you a longer or different cooling-off period.

After receiving a refund:

- your Stellar subscription will be canceled, and access to premium features will end when the refund is processed; and
- we may temporarily restrict your ability to purchase a new Stellar subscription for a period of up to 30 days to reduce the risk of payment abuse.

If you request refunds for Stellar subscriptions multiple times, we may restrict or block your ability to purchase Stellar again if we reasonably believe your refund requests are abusive or present an unacceptable risk of payment abuse. In exceptional cases, we may restore purchasing access at our discretion, taking into account your account history and the circumstances of the refunds.
...
If you purchase a Stellar gift code and subsequently request a refund or initiate a chargeback for that purchase:
...
- you remain responsible for any unpaid amounts owed to Noctis.
...
If you believe there is an error or unauthorized charge on your Account, we encourage you to contact us first at support@noctis.app so we can investigate and attempt to resolve the issue quickly.

If you initiate a chargeback or payment dispute with your bank or payment provider for a payment made to Noctis, we may:
...
If a chargeback is resolved against us and we have a reasonable basis to believe it was made in bad faith or as part of a pattern of abuse or fraud, we may close your Account or permanently restrict your ability to purchase Stellar or other paid Services. We will consider any information you provide when deciding these measures.
...
Noctis integrates with and relies upon various third-party services to provide the Services, including hosting and infrastructure providers, payment processors, content delivery networks, security services, and communication platforms.
...
These third-party services have their own independent terms of service and privacy policies. Your use of such services may be subject to those additional terms. Noctis is not responsible for the content, availability, policies, or practices of third-party services.
...
If you believe we have made a mistake in suspending or terminating your Account, you may appeal in accordance with our [Community Guidelines](/guidelines), for example by emailing appeals@noctis.app from the email address associated with your Account.
...
You can remove messages and other content through your Privacy Dashboard or by contacting privacy@noctis.app before deletion, subject to technical and legal limitations.

## 9. Disclaimers, Limitation of Liability, and Indemnification

### 9.1 No Warranties

We work diligently to maintain Noctis as a reliable and stable platform, but the Services are provided on an "as is" and "as available" basis.

To the fullest extent permitted by law, Noctis and its affiliates make no express or implied warranties or representations about the Services, including but not limited to warranties of merchantability, fitness for a particular purpose, non-infringement, or that the Services will be uninterrupted, secure, or error-free.
...
To the maximum extent permitted by applicable law, Noctis and its affiliates will not be liable for:
...
- EUR 100; or
- the total amount you have paid to Noctis for the Services during the twelve (12) months immediately preceding the event giving rise to the claim.
...
To the extent permitted by applicable law, you agree to defend, indemnify, and hold harmless Noctis, its officers, directors, employees, and agents from and against any claims, demands, actions, damages, losses, and expenses (including reasonable legal fees) arising out of or related to:
...
- **Informal resolution first:** If you have a concern or dispute with us, please contact support@noctis.app first. We will try to work with you in good faith to resolve the issue informally.
...
All account-related communications with Noctis should be sent from the email address associated with your Account. We use this as our primary method of verifying your identity and ensuring we are communicating with the actual Account holder.
...
Noctis will never ask you to provide your password, full payment card number, or other highly sensitive security information via email. All official Noctis emails and communications originate from email addresses ending in `@noctis.app` or `@m.noctis.app`. Be cautious of phishing attempts using similar-looking domain names or requesting sensitive information.

If you receive a suspicious message claiming to be from Noctis, please do not click any links or provide any information. Instead, contact us directly at support@noctis.app.

## 13. Contact Information

If you have questions, concerns, or need assistance with the Services or these Terms, you can contact us at:

- **Support email:** support@noctis.app (for account-related matters, please contact us from the email address associated with your Account where possible)
- **Privacy email:** privacy@noctis.app (for privacy and data protection requests)
- **Website:** [https://noctis.app](https://noctis.app)
