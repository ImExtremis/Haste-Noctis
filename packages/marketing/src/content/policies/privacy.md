...
- We do not sell, rent, or trade your personal data to third parties. We also do not "sell" or "share" personal information for cross-context behavioral advertising as defined by the CCPA/CPRA in relation to Noctis. When you interact with third-party content such as embedded YouTube videos, those third parties may collect and use information under their own privacy policies, which may include advertising in their own services.
...
- We do not train AI models on your messages, files, or any other content you create or share on Noctis.
...
- Where we use automated systems that significantly affect your access to Noctis (for example, regional eligibility checks based on IP geolocation), we do so in line with applicable law and describe your rights in this policy.
...
We are **Haste Industries**, a Swedish limited liability company (Swedish organization number: 559537-3993). We operate the Noctis chat platform and related services.

Haste Industries is the "data controller" for your personal data when you use Noctis, meaning we determine how and why your personal data is processed.
...
When you use Noctis, we automatically collect certain technical and usage information, including:
...
- **Usage information:** Information about how you interact with Noctis, such as:
...
- To provide, operate, and maintain the Noctis platform and services.
...
- To protect the safety, rights, and property of our users, the public, and Noctis.

We do not use your messages, files, or any other content you create or share on Noctis for targeted advertising or for training AI models.
...
We share your information when you intentionally interact with others on Noctis, for example:
...
In these cases, other users can see the information you choose to share, and they may further share or store it outside Noctis. We encourage you to be mindful about the content you share and with whom.

### 4.2 With Service Providers

We work with trusted third-party service providers who process data on our behalf to help us operate Noctis. These providers include:
...
- **Cloudflare** – content delivery network (CDN) for delivery and caching of user-generated content on the `noctisusercontent.com` domain.
...
- protect the safety, rights, or property of our users, the public, or Noctis; or
...
We use automated tools and, in limited circumstances, human review to help keep Noctis safe and compliant with the law.
...
- **What is not scanned:** Text messages and the main Noctis application traffic are not scanned by this tool.
...
- **User-generated content CDN:** Cloudflare edge locations worldwide (for content on the `noctisusercontent.com` domain).
...
For active accounts, we generally keep your personal data for as long as you use Noctis. This includes your messages, Communities, and other User Content while your account remains active, unless you delete specific content yourself.
...
You have several tools and settings to help you manage your data and privacy on Noctis.
...
- Email privacy@noctis.app from the email address associated with your Noctis account.
...
- **Rights under CCPA/CPRA (for California residents):** The following rights apply:
  ...
  - right to opt out of the sale or sharing of personal information (we do not sell or share personal information for cross-context behavioral advertising in relation to Noctis); and
...
You can also contact us at privacy@noctis.app to exercise your rights. When you do so:
...
We use automated systems in certain limited ways that may affect your use of Noctis, such as:

- determining whether your approximate location is in a region where access to Noctis is permitted based on IP geolocation and applicable laws; and
- detecting potential fraud, spam, or abusive behavior.

These systems can influence, for example, whether you can access Noctis from a given region or whether certain actions are temporarily blocked while we investigate potential abuse.

Where applicable law (such as GDPR) grants you rights related to automated decision-making – such as the right to obtain human review, to express your point of view, or to contest certain decisions – you can contact us at privacy@noctis.app. We will handle such requests in line with those laws and our legal obligations.

## 11. Children's Privacy

Users must meet the minimum age requirement in their region to create and use a Noctis account. We determine eligibility based on your self-reported information and your approximate geographic location.

For the purposes of this policy and our Terms of Service:

- the **minimum age to use Noctis** (the "Minimum Age") is the lowest age at which applicable law in your country permits you to use an online service like Noctis. This is typically 13 years old, but it varies by country and may be higher in certain jurisdictions; and
- users who are **above the Minimum Age but under the age of legal majority** in their jurisdiction (for example, under 18 in many countries) may use Noctis, but our Terms require a parent or guardian to review and agree to them on the user's behalf.
...
We generally do not manually override these automated regional determinations, but you may contact us at privacy@noctis.app if you believe your access has been restricted in error (for example, due to inaccurate geolocation). Where applicable law grants minors or their guardians specific rights regarding automated decisions, we will comply with those obligations.
...
If you are a parent or legal guardian and believe that your child has used Noctis without your consent or does not meet the Minimum Age requirement, you may contact privacy@noctis.app from the child's registered email address (or with sufficient proof of guardianship) to request deletion of their account and associated data.

## 12. Cookies and Similar Technologies

### 12.1 Noctis Application

We do not use third-party advertising or tracking cookies for our own analytics or advertising in the Noctis application. Any cookies we set are strictly necessary for the operation and security of the service. We also do not run advertising trackers or analytics SDKs in the app. Operational logging and limited feature-usage telemetry are stored server-side to keep the service reliable and secure and to understand which features are used. This server-side data is not used for advertising or cross-site profiling.
...
On our marketing website (`noctis.app`):
...
Noctis may contain links to third-party websites, services, or content (for example, YouTube videos, GIF search, or other embedded content). When you use these features:
...
- for GIF search through KLIPY, both search queries and GIF embedding are routed through our servers, so this provider does not see your IP address or device identifiers for searches or when GIFs are displayed in Noctis;
...
- Requests should be directed to legal@noctis.app and should clearly identify the requesting authority, legal basis, and scope of data requested.
...
Your continued use of Noctis after the updated policy takes effect constitutes your acceptance of the changes. If you do not agree with the updated policy, you should stop using Noctis and, if you wish, delete your account.

## 16. Contact Us

For account-related and privacy-related requests, you should contact us from the email address associated with your Noctis account wherever possible. This helps us verify your identity and protect your account.

### Privacy and Data Protection Contact

- Email: privacy@noctis.app
