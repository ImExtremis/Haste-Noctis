...
Noctis is a platform designed for communication, connection, and community building. These community guidelines help ensure that everyone can use the platform safely and respectfully. They form an integral part of our Terms of Service, and violations may result in warnings, content removal, restrictions, or account suspension or termination.

These guidelines apply to all users of Noctis without exception. They govern all interactions on the platform, including (but not limited to):
...
Noctis is built for real people. Behind every username is a person who deserves to be treated with basic dignity.

## Positive Participation

We want Noctis to be safe, welcoming, and constructive. You can help by:
...
The following behaviors are strictly prohibited on Noctis and may result in enforcement action, including content removal, account restrictions, or bans.
...
Do not use Noctis to facilitate, promote, or engage in illegal activities. This includes, but is not limited to:
...
- evasion of lawful blocks or sanctions using the service (for example, using Noctis where export control or sanctions laws prohibit it); or
...
Do not abuse or misuse the Noctis platform in the following ways:
...
- buying, selling, renting, or trading Noctis accounts or Communities;
...
Limited automation that complies with our policies and applicable law may be allowed where explicitly permitted by Noctis. Otherwise, automated abuse is prohibited.
...
- engage in stalking, doxxing, surveillance, or other invasive monitoring of users on or off the platform in connection with their use of Noctis.
...
- email our safety team at safety@noctis.app.
...
1. Send an email to appeals@noctis.app from the email address associated with your Noctis account.
2. Clearly state:
...
Users must meet the **Minimum Age** to use Noctis as described in our [Terms of Service](/terms) and [Privacy Policy](/privacy). This Minimum Age is typically 13 but may be higher in some countries.
...
If you are under 18, please be especially cautious about sharing personal information, and do not meet people from Noctis in person without involving a trusted adult and ensuring your safety.
...
- You may set stricter rules than Noctis's baseline, but not more permissive ones.
...
If you are unsure how to handle a safety issue that affects your Community, you can always report it to us or contact safety@noctis.app for guidance.

### For Parents and Guardians

We understand that online safety is especially important for younger users.

- We provide safety resources and guidance on our website to help parents and guardians understand how Noctis works and how to support young users.
...
- If you see content that suggests someone may be at imminent risk of self-harm or harm to others:
  - report it via in-app tools or email safety@noctis.app; and
...
Noctis is not a substitute for professional mental health care or emergency services.
...
Your continued use of Noctis after updated guidelines take effect constitutes your acceptance of those changes. If you do not agree with updated guidelines, you should stop using Noctis and may delete your account.

## Final Thoughts

The vast majority of Noctis users engage with our platform responsibly and never have any issues with these guidelines.
...
Thank you for helping us keep Noctis a safe, welcoming, and enjoyable place to connect and communicate.
...
- Direct lawful process and urgent preservation requests to legal@noctis.app.
...
- For other urgent safety concerns on Noctis (for example, threats, self-harm indications, or serious harassment), please:
  - use in-app reporting tools; and/or
  - email safety@noctis.app with as much detail as possible so we can review quickly.

Noctis cannot provide medical, psychological, or legal advice. However, we will do our best to respond to safety-related reports promptly and, where appropriate, may work with relevant services or authorities consistent with applicable law.
