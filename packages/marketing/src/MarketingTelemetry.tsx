...
import type {LocaleCode} from '@noctis/constants/src/Locales';
import {parseSession} from '@noctis/hono/src/Session';
import {getLocaleFromCode, parseAcceptLanguage} from '@noctis/locale/src/LocaleService';
import {detectArchitecture, detectPlatform} from '@noctis/marketing/src/DeviceUtils';
import {getCountryCode} from '@noctis/marketing/src/GeoIp';
import type {MarketingConfig} from '@noctis/marketing/src/MarketingConfig';
import type {MarketingArchitecture, MarketingPlatform} from '@noctis/marketing/src/MarketingContext';
