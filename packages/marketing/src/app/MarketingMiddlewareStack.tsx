...
import type {HttpStatusCode} from '@noctis/constants/src/HttpConstants';
...
import {cacheHeadersMiddleware} from '@noctis/marketing/src/middleware/CacheHeadersMiddleware';
import {marketingCsrfMiddleware} from '@noctis/marketing/src/middleware/Csrf';
...
import {ErrorPage} from '@noctis/ui/src/pages/ErrorPage';
...
function createMarketingErrorHandler(logger: LoggerInterface, config: MarketingConfig): HonoErrorHandler {
	...
	return createErrorHandler({
		...
		logError: (error, c) => {
			if (!(error instanceof NoctisError)) {
