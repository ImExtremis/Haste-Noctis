...
import {renderDonationForm, renderDonationScript} from '@noctis/marketing/src/pages/donations/DonationForm';
import {renderDonationManageForm} from '@noctis/marketing/src/pages/donations/DonationManageForm';
