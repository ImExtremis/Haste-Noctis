...
import {Footer} from '@noctis/marketing/src/components/Footer';
import {LocaleSelectorModal} from '@noctis/marketing/src/components/LocaleSelector';
import {Navigation} from '@noctis/marketing/src/components/Navigation';
import type {MarketingContext} from '@noctis/marketing/src/MarketingContext';
import {getCurrentPath} from '@noctis/marketing/src/PathUtils';
import {buildIconLinks} from '@noctis/marketing/src/pages/layout/Icons';
import type {PageMeta} from '@noctis/marketing/src/pages/layout/Meta';
import {buildMetaTags} from '@noctis/marketing/src/pages/layout/Meta';
import {docsPageScript, downloadScript, mainPageScript} from '@noctis/marketing/src/pages/layout/Scripts';
import {cacheBustedAsset} from '@noctis/marketing/src/UrlUtils';
	...
	return (
		<html lang={ctx.locale}>
			<head>
				...
				<link rel="preconnect" href="https://static.noctis.app" />
				<link rel="stylesheet" href="https://static.noctis.app/fonts/ibm-plex.css" />
				<link rel="stylesheet" href="https://static.noctis.app/fonts/bricolage.css" />
