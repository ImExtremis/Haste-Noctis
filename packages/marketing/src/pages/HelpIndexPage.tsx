...
import type {HelpArticleMetadata} from '@noctis/marketing/src/content/help/Metadata';
import {getHelpArticles} from '@noctis/marketing/src/help/HelpContentLoader';
...
export async function renderHelpIndexPage(c: Context, ctx: MarketingContext): Promise<Response> {
	...
	const meta = pageMeta(
		`Noctis | ${ctx.i18n.getMessage('company_and_resources.help.help_center', ctx.locale)}`,
