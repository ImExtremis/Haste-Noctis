...
import {type PressAssetDefinition, PressAssetIds, PressAssets} from '@noctis/constants/src/PressAssets';
import {defaultHeroPadding, HeroBase} from '@noctis/marketing/src/components/HeroBase';
import {DownloadArrowIcon} from '@noctis/marketing/src/components/icons/DownloadArrowIcon';
...
export async function renderPressPage(c: Context, ctx: MarketingContext): Promise<Response> {
	...
	const meta = pageMeta(
		...
		ctx.i18n.getMessage('navigation.press.download_noctis_assets', ctx.locale),
		'website',
	);
