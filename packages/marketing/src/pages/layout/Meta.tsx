...
export function defaultPageMeta(): PageMeta {
	return {
		title: 'Noctis: A chat app that puts you first',
		description:
...
export function formatPageTitle(baseTitle: string): string {
	if (baseTitle === 'Noctis') return 'Noctis';
	return `Noctis | ${baseTitle}`;
}
...
export function buildMetaTags(ctx: MarketingContext, meta: PageMeta, pageUrl: string): ReadonlyArray<JSX.Element> {
	...
	return [
		...
		<meta property="og:site_name" content="Noctis" />,
		...
		<meta name="author" content="Noctis Team" />,
		<link rel="canonical" href={pageUrl} />,
		<link
			rel="alternate"
			type="application/rss+xml"
			title={ctx.i18n.getMessage('social_and_feeds.rss.noctis_blog_rss', ctx.locale)}
