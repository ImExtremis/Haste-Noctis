...
import {ParserFlags} from '@noctis/markdown_parser/src/types/Enums';
import {renderAstToHtml} from '@noctis/marketing/src/markdown/AstHtmlRenderer';
...
const HORIZONTAL_RULE_MARKER = 'NOCTIS_HORIZONTAL_RULE_PLACEHOLDER';
const SECTION_REFERENCE_PLACEHOLDER_PREFIX = 'NOCTIS_SECTION_REF_';
