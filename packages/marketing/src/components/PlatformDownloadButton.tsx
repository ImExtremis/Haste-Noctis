...
import {AndroidIcon} from '@noctis/marketing/src/components/icons/AndroidIcon';
import {AppleIcon} from '@noctis/marketing/src/components/icons/AppleIcon';
import {CaretDownIcon} from '@noctis/marketing/src/components/icons/CaretDownIcon';
import {DownloadIcon} from '@noctis/marketing/src/components/icons/DownloadIcon';
import {LinuxIcon} from '@noctis/marketing/src/components/icons/LinuxIcon';
import {WindowsIcon} from '@noctis/marketing/src/components/icons/WindowsIcon';
import type {MarketingContext, MarketingPlatform} from '@noctis/marketing/src/MarketingContext';
import {apiUrl, href, isCanary} from '@noctis/marketing/src/UrlUtils';
		...
		default:
			button = (
				...
				>
					...
					<span>{ctx.i18n.getMessage('download.download_noctis', ctx.locale)}</span>
				</a>
			);
			break;
	}
