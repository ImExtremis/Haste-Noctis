...
import {ArrowRightIcon} from '@noctis/marketing/src/components/icons/ArrowRightIcon';
...
import {MarketingButtonInverted} from '@noctis/marketing/src/components/MarketingButton';
	...
	return (
		...
		>
			<div class="mx-auto max-w-7xl">
				...
				<div class="mb-10">
					<NoctisLogoWordmarkIcon class="h-8" />
				</div>
				...
				<div class="grid grid-cols-1 gap-8 sm:grid-cols-3 sm:gap-10 md:gap-x-12 md:gap-y-10 min-[480px]:grid-cols-2 min-[480px]:gap-x-6 min-[480px]:gap-y-8">
					<FooterSection title={ctx.i18n.getMessage('footer.noctis', ctx.locale)}>
						<FooterLink href={link('/stellar')}>
							{ctx.i18n.getMessage('footer.stellar_tier', ctx.locale)}
						</FooterLink>
						...
						<FooterLink href="https://github.com/noctisapp/noctis">
							{ctx.i18n.getMessage('footer.source_code', ctx.locale)}
						</FooterLink>
						<FooterLink href="https://bsky.app/profile/noctis.app">
							{ctx.i18n.getMessage('footer.bluesky_social_media', ctx.locale)}
						</FooterLink>
						<li>
							<div class="flex items-center gap-2">
								<a href="https://blog.noctis.app" class={linkClass}>
						...
						<FooterLink href="https://blog.noctis.app/roadmap-2026">
						...
						<FooterLink href="https://docs.noctis.app">
					...
					>
						<FooterLink href="mailto:press@noctis.app">press@noctis.app</FooterLink>
						<FooterLink href="mailto:support@noctis.app">support@noctis.app</FooterLink>
				...
				<div class="mt-12 pt-8">
					<p class="body-sm text-white/80">
						{ctx.i18n.getMessage('footer.noctis_platform_ab_swedish_limited', ctx.locale)}
					</p>
				</div>
			</div>
		</footer>
