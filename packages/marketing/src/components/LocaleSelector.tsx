...
import {AllLocales} from '@noctis/constants/src/Locales';
import {getLocaleName} from '@noctis/locale/src/LocaleService';
...
import {href, prependBasePath} from '@noctis/marketing/src/UrlUtils';
