...
import {FeatureCard} from '@noctis/marketing/src/components/FeatureCard';
			...
			<div class="grid grid-cols-1 gap-6 md:gap-8 lg:grid-cols-2">
				...
				<FeatureCard
					...
					features={[
						...
						ctx.i18n.getMessage('pricing_and_tiers.stellar.features.webhooks_and_bot_support', ctx.locale),
					]}
				/>
				<FeatureCard
					ctx={ctx}
				...
				<FeatureCard
					...
					learnMoreLink="https://docs.noctis.app/self-hosting"
				/>
			</div>
		</Section>
	);
