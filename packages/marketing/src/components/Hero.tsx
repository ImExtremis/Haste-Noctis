...
import {FlagSvg} from '@noctis/marketing/src/components/Flags';
import {HackernewsBanner} from '@noctis/marketing/src/components/HackernewsBanner';
import {ArrowRightIcon} from '@noctis/marketing/src/components/icons/ArrowRightIcon';
import {renderSecondaryButton, renderWithOverlay} from '@noctis/marketing/src/components/PlatformDownloadButton';
			...
			<div class="max-w-4xl space-y-8 text-center">
				{ctx.locale === 'ja' ? (
					<div class="flex justify-center">
						<span class="font-bold text-3xl text-white">Noctis（フラクサー）</span>
					</div>
				) : null}
				<div class="flex flex-wrap items-center justify-center gap-3 pb-2">
					<a
						href="https://blog.noctis.app/how-i-built-noctis-a-discord-like-chat-app/"
						target="_blank"
					...
					<a
						href="https://blog.noctis.app/roadmap-2026"
						target="_blank"
						rel="noopener noreferrer"
						class="inline-flex items-center gap-1.5 rounded-full bg-white/10 px-4 py-1.5 font-medium text-sm text-white transition-colors hover:bg-white/20"
					>
