...
import {MarketingCard} from '@noctis/marketing/src/components/MarketingCard';
		...
		>
			<div class="grid grid-cols-1 gap-8 md:grid-cols-2 md:gap-10">
				...
				<SupportCard
					...
					title={ctx.i18n.getMessage('misc_labels.join_noctis_hq', ctx.locale)}
				...
				>
					<div class="mb-8 text-center">
						...
						<p class="body-lg text-gray-700 leading-relaxed">
							...
							<a
								href="https://bsky.app/profile/noctis.app/rss"
					...
					<div class="mt-auto flex flex-col items-center">
						...
						>
							{ctx.i18n.getMessage('social_and_feeds.follow_noctis', ctx.locale)}
						</MarketingButton>
					</div>
				</MarketingCard>
				<SupportCard
