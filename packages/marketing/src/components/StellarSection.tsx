...
import {getFormattedPrice, PricingTier} from '@noctis/marketing/src/PricingUtils';
import {href} from '@noctis/marketing/src/UrlUtils';

interface StellarSectionProps {
	ctx: MarketingContext;
}

export function StellarSection(props: StellarSectionProps): JSX.Element {
	const {ctx} = props;
	...
	return (
		<Section
			variant="light"
			title={ctx.i18n.getMessage('pricing_and_tiers.stellar.get_more_with_stellar', ctx.locale)}
			className="md:py-28"
		>
			...
			<p class="lead mx-auto max-w-2xl text-gray-700">
				{ctx.i18n.getMessage('pricing_and_tiers.stellar.higher_limits_and_early_access', ctx.locale)}
			</p>
			...
			<div class="text-center">
				<MarketingButton href={href(ctx, '/stellar')} size="large" class="label md:text-xl">
