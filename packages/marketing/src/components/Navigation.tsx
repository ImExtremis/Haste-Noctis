...
import {DownloadIcon} from '@noctis/marketing/src/components/icons/DownloadIcon';
import {NoctisLogoWordmarkIcon} from '@noctis/marketing/src/components/icons/NoctisLogoWordmarkIcon';
import {GithubIcon} from '@noctis/marketing/src/components/icons/GithubIcon';
import {MenuIcon} from '@noctis/marketing/src/components/icons/MenuIcon';
import {RssIcon} from '@noctis/marketing/src/components/icons/RssIcon';
import {TranslateIcon} from '@noctis/marketing/src/components/icons/TranslateIcon';
import {XIcon} from '@noctis/marketing/src/components/icons/XIcon';
import {LocaleSelectorTrigger} from '@noctis/marketing/src/components/LocaleSelector';
import {MarketingButton} from '@noctis/marketing/src/components/MarketingButton';
import {getPlatformDownloadInfo} from '@noctis/marketing/src/components/PlatformDownloadButton';
import type {MarketingContext} from '@noctis/marketing/src/MarketingContext';
import {href} from '@noctis/marketing/src/UrlUtils';
				...
				<div class="mx-auto max-w-7xl rounded-2xl border border-gray-200/60 bg-white/95 px-3 py-2 shadow-lg backdrop-blur-lg md:px-5 md:py-2.5">
					<div class="flex items-center justify-between">
						<div class="flex items-center gap-4 xl:gap-6">
							...
							>
								<NoctisLogoWordmarkIcon class="h-8 text-[#4641D9] md:h-9" />
						...
						<div class="flex items-center gap-1 xl:gap-2">
							<a
								href="https://bsky.app/profile/noctis.app"
							...
							<a
								href="https://github.com/noctisapp/noctis"
								class="hidden items-center rounded-lg p-2 text-[#4641D9] transition-colors hover:bg-gray-100 hover:text-[#3d38c7] lg:flex"
								target="_blank"
								rel="noopener noreferrer"
							...
							<a
								href="https://blog.noctis.app/rss/"
							...
							>
								{ctx.i18n.getMessage('app.open.open_noctis', ctx.locale)}
							</MarketingButton>
							<label
								for="nav-toggle"
				...
				<div class="flex h-full flex-col p-6">
					<div class="mb-6 flex items-center justify-between">
						<a
							...
							aria-label={ctx.i18n.getMessage('navigation.go_home', ctx.locale)}
						>
							<NoctisLogoWordmarkIcon class="h-7 text-[#4641D9]" />
						</a>
