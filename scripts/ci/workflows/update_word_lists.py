...
""",
    "check_changes": """
set -euo pipefail
if ! diff -q /tmp/scales.txt noctis_api/src/words/scales.txt > /dev/null 2>&1 || \
   ! diff -q /tmp/tails.txt noctis_api/src/words/tails.txt > /dev/null 2>&1; then
...
""",
    "update": """
set -euo pipefail
cp /tmp/scales.txt noctis_api/src/words/scales.txt
cp /tmp/tails.txt noctis_api/src/words/tails.txt
""",
    "no_changes": """
