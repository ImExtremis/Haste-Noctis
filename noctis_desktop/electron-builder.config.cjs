...
const productName = isCanary ? 'Noctis Canary' : 'Noctis';
const appId = isCanary ? 'app.noctis.canary' : 'app.noctis';
const iconDir = isCanary ? 'icons-canary' : 'icons-stable';
const packageName = isCanary ? 'noctis_desktop_canary' : 'noctis_desktop';
...
module.exports = {
	...
	mac: {
		...
		extendInfo: {
			NSMicrophoneUsageDescription: 'Noctis needs access to your microphone to enable voice chat features.',
			NSCameraUsageDescription: 'Noctis needs access to your camera to enable video chat features.',
			NSAppleEventsUsageDescription: 'Noctis needs access to Apple Events for automation features.',
		},
	},
	...
	squirrelWindows: {
		iconUrl: `https://static.noctis.app/desktop/${iconDir}/icon.ico`,
		name: packageName,
	},
	...
	linux: {
		...
		desktop: {
			...
			StartupWMClass: isCanary ? 'noctis-canary' : 'noctis',
		},
	},
