...
-module(noctis_relay_ws_handler).
...
init(Req, _State) ->
    ...
    IdleTimeout = noctis_relay_env:get(idle_timeout_ms),
...
connect_to_instance(InstanceId, State) ->
    Config = noctis_relay_env:get_map(),
    ...
    GatewayResult = case InstanceId of
        ...
        _ ->
            noctis_relay_instance_discovery:discover_gateway(InstanceId)
    end,
