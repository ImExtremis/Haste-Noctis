...
import {Config, type Config as NoctisServerConfig} from '@app/Config';
...
import {getSnowflakeService} from '@noctis/api/src/middleware/ServiceRegistry';
...
import {createServerWithUpgrade} from '@noctis/hono/src/Server';
import type {BaseHonoEnv} from '@noctis/hono_types/src/HonoTypes';
import type {Hono} from 'hono';

export interface NoctisServerOptions {
	config?: NoctisServerConfig;
	staticDir?: string;
}

export interface NoctisServerResult {
...
export async function createNoctisServer(options: NoctisServerOptions = {}): Promise<NoctisServerResult> {
	...
	const shutdown = async (): Promise<void> => {
		...
		Logger.info('Beginning graceful shutdown of Noctis Server');
		...
		Logger.info('Noctis Server shutdown complete');
	};
