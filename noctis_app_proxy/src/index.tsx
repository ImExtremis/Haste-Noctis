...
import {createAppProxyApp} from '@noctis/app_proxy/src/App';
import {buildNoctisCSPOptions} from '@noctis/app_proxy/src/app_server/utils/CSP';
...
const telemetry = createServiceTelemetry({
	serviceName: 'noctis-app-proxy',
	skipPaths: ['/_health'],
});

async function main(): Promise<void> {
	const cspDirectives = buildNoctisCSPOptions({sentryDsn: Config.sentry_dsn});
	...
	Logger.info({port}, 'Starting Noctis App Proxy');
