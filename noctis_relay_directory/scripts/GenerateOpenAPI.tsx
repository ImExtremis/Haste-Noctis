...
import {zodToOpenAPISchema} from '@noctis/openapi/src/converters/ZodToOpenAPI';
import {
	HealthCheckResponse,
...
} from '@noctis/schema/src/domains/relay/RelaySchemas';
...
function generateSpec(): OpenAPISpec {
	...
	const spec: OpenAPISpec = {
		openapi: '3.1.0',
		info: {
			title: 'Noctis Relay Directory API',
			version: '1.0.0',
			description:
				'API for discovering and managing Noctis relay servers. ' +
				'The relay directory service maintains a registry of available relay servers ' +
				'that clients can use to connect to Noctis instances through encrypted tunnels.',
			contact: {
...
function main(): void {
	console.log('Noctis Relay Directory OpenAPI Generator');
	console.log('========================================');
	console.log('');
	...
	const outputPath = path.resolve(scriptDir, '../../noctis_docs/relay-api/openapi.json');
